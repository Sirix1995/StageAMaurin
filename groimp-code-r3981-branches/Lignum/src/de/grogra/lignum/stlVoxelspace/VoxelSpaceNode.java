...
import de.grogra.blocks.NullWithShaderNode;
...
public class VoxelSpaceNode extends NullWithShaderNode implements VoxelSpaceIF, de.grogra.xl.modules.Instantiator<Instantiation>, Mathsym {

	/**
	 * Default serial ID.
	 */
	private static final long serialVersionUID = 123234512621L;
	...
	/**
	 * Default constructor.
	 * corner1=(0,0,0), corner2=(1,1,1) 
	 * 5,5,5 number of VoxBoxes in x,y, and z direction
	 * 
	 */
	public VoxelSpaceNode() {
		this(new Point3d(0,0,0), new Point3d(1,1,1), 5, 5, 5, new Firmament());
	}	
	...
	public VoxelSpaceNode(Point3d c1, Point3d c2, int xn, int yn, int zn, Firmament f) {
		Xn = xn;
		Yn = yn;
		Zn = zn;
	...
	public VoxelSpaceNode(Point3d c1, Point3d c2, double xsize, double ysize, double zsize, int xn, int yn, int zn, 
	...
	public void instantiate(Instantiation state) {
		if (visible) {
		Instantiation inst = state;
		float radius = 0.003f;
		float XLength = (float)(Xn*Xbox);
		float YLength = (float)(Yn*Ybox);
		float ZLength = (float)(Zn*Zbox);
			//for each level
			for(int i=0; i<=Zn; i++) {
				for(int j=0; j<=Xn; j++) {
					inst.producer$push();
					inst.instantiate(new Null(j*Xbox, 0, i*Zbox));
					inst.instantiate(new RL(-90));
					inst.instantiate(new Cylinder(YLength, radius));
					inst.producer$pop(null);
				}
				for(int k=0; k<=Yn; k++) {
					inst.producer$push();
					inst.instantiate(new Null(0, k*Ybox, i*Zbox));
					inst.instantiate(new RU(90));
					inst.instantiate(new Cylinder(XLength, radius));
					inst.producer$pop(null);
				}
			}
			for(int i=0; i<=Xn; i++) {
				for(int j=0; j<=Yn; j++) {
					inst.producer$push();
					inst.instantiate(new Null(i*Xbox, j*Ybox, 0));
					inst.instantiate(new Cylinder(ZLength, radius));
					inst.producer$pop(null);
				}
			}
		}
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getXindex(double)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getYindex(double)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getZindex(double)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#reset()
	 */
    public void reset() {
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#resetQinQabs()
	 */
  ...
  //Change number (=input) of VoxelBoxes in x, y, and z-directions. The whole
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#resize(int, int, int)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#resize(double, double, double)
	 */
    ...
    //changes (i.e. corner2)
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#resize(double, double, double, int, int, int)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#resize(javax.vecmath.Point3d, javax.vecmath.Point3d)
	 */
    ...
    //corner1
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#move(javax.vecmath.Point3d)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getBookKeeper()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getForestDescriptor()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getArea()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getLowerLeftCorner()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getUpperRightCorner()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getNumberOfBoxes()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getNumberOfFilledBoxes()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getNumberOfTreeSegments()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getBoxVolume()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getXSideLength()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getYSideLength()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getZSideLength()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getQabs()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getQin()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getMinMaxNeedleMass()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getFoliageMass()
	 */
    ...
    //
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getVoxelBox(javax.vecmath.Point3d)
	 */
    ...
    //
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getBoxIndexes(javax.vecmath.Point3d)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getRoute(java.util.Vector, int, int, int, de.grogra.lignum.jadt.PositionVector)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getRoute(java.util.Vector, javax.vecmath.Point3d, de.grogra.lignum.jadt.PositionVector, de.grogra.lignum.jadt.ParametricCurve, boolean)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getBorderStandExtinction(javax.vecmath.Point3d, de.grogra.lignum.jadt.PositionVector)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#updateBoxValues()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#calculateTurbidLight()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#calculateTurbidLight(boolean)
	 */
  ...
  /*  public double calculatePoplarLight(double diffuse, double structureFlag) {
   ...
   /* public void setLightValues() {
    ...
    //
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#fillVoxelBoxes(double, double)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#fillVoxelBoxes(double, int, int)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#FillVoxelBoxesWithNeedles(double, double, double, double, int, int)
	 */
	...
	*/ //TODO : Where are those functions declared in cLignum?
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getMeanFoliageAreaDensity()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#calculateMeanQabsQin()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getNeedleArea()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getLeafArea()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#getFoliageArea()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.grogra.lignum.stlVoxelspace.VoxelSpaceIF2#evaluateVerticalNeedleAreaDensity(double, double, int, java.util.Vector)
	 */
    ...
    public void DumpCfTree(VoxelSpaceIF s, Tree tree, int num_parts, boolean wood) {
...
// NOTE: The following lines up to enh:end were generated automatically
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (VoxelSpaceNode.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
		...
		public void setBoolean (Object o, boolean value)
		{
			...
			{
				case 0:
					((VoxelSpaceNode) o).visible = value;
					return;
			}
		...
		public boolean getBoolean (Object o)
		{
			...
			{
				case 0:
					return ((VoxelSpaceNode) o).isVisible ();
			}
	...
	static
	{
		$TYPE = new NType (new VoxelSpaceNode ());
		$TYPE.addManagedField (visible$FIELD = new _Field ("visible", _Field.PUBLIC  | _Field.SCO, de.grogra.reflect.Type.BOOLEAN, null, 0));
		$TYPE.validate ();
	}
