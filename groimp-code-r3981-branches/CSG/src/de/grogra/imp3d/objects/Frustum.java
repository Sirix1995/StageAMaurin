...
public class Frustum extends FrustumBase implements Raytraceable, Polygonizable, CSGable
{
			 ...
			 int flags, float flatness)
	{
		...
		for (int u = 0; u <= uCount; u++)
		{
			...
			vertices.add((float) (tr * cosPhi));
			vertices.add((float) (tr * sinPhi));
			vertices.add(l);
			...
			vertices.add((float) (br * cosPhi));
			vertices.add((float) (br * sinPhi));
			vertices.add(0);
...
// NOTE: The following lines up to enh:end were generated automatically
	...
	private static final class _Field extends NType.Field
	{
		...
		public void setFloat (Object o, float value)
		{
			...
			{
				case 0:
					((Frustum) o).baseRadius = (float) value;
					return;
				case 1:
					((Frustum) o).topRadius = (float) value;
					return;
			}
	...
	public HalfEdgeStructCSG getMesh() {
		System.out.println("insert Frustrum");
		// TODO Auto-generated method stub
		HalfEdgeStructCSG	meshed = new HalfEdgeStructCSG();
		de.grogra.imp3d.HalfEdgeUtil.insertFrustum(32, this.baseRadius, this.topRadius, meshed);
//		meshed.insertFrustum(8, true, this.baseRadius, true, this.topRadius);
