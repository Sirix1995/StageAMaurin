...
public class Cylinder extends FrustumBase implements Raytraceable, Polygonizable, CSGable
{
			 ...
			 int flags, float flatness)
	{
		...
		for (int u = 0; u <= uCount; u++)
		{
			...
			vertices.add((float) (r * cosPhi));
			vertices.add((float) (r * sinPhi));
			vertices.add(l);
...
//		System.out.println("insert Cylinder");
		// TODO Auto-generated method stub
		HalfEdgeStructCSG	meshed = new HalfEdgeStructCSG();
		de.grogra.imp3d.HalfEdgeUtil.insertFrustum(8, this.radius, this.radius, meshed);
//		meshed.insertFrustum(8, true, this.radius, true, this.radius);
		Matrix4d transformation = new Matrix4d();
		transformation.setIdentity();
		transformation.m22 = (float)this.length; 
		meshed.transform(transformation);
//		meshed.printState();
