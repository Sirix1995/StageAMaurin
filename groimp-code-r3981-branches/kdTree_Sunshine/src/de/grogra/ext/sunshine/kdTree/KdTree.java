...
public class KdTree
{
	...
	public KdTree(int s, OctreeUnion octree)
	{
		...
		treeTex.putFloat(CHILDRENLINK, SIZEOF_CELL);
	...
	private void storeChildrenLink(Cell cell)
	{
		...
		{
			treeTex.putFloat(cellCache.get(cell) + CHILDRENLINK, cellCache.get(cell.children[0]));
			System.out.println("CHILDRENLINK = " + cellCache.get(cell.children[0]) );
		}
	}
	...
	private void print() 
	{
		...
		m.m00 = treeTex.getFloat();
		m.m10 = treeTex.getFloat();
		m.m20 = treeTex.getFloat();
		m.m30 = 0;
		
		m.m01 = treeTex.getFloat();
		m.m11 = treeTex.getFloat();
		m.m21 = treeTex.getFloat();
		m.m31 = 0;
		
		m.m02 = treeTex.getFloat();
		m.m12 = treeTex.getFloat();
		m.m22 = treeTex.getFloat();
		m.m32 = 0;
		
		m.m03 = treeTex.getFloat();
		m.m13 = treeTex.getFloat();
		m.m23 = treeTex.getFloat();
		m.m33 = 1;
		...
		m1.m00 = treeTex.getFloat();
		m1.m10 = treeTex.getFloat();
		m1.m20 = treeTex.getFloat();
		m1.m30 = treeTex.getFloat();
		
		m1.m01 = treeTex.getFloat();
		m1.m11 = treeTex.getFloat();
		m1.m21 = treeTex.getFloat();
		m1.m31 = treeTex.getFloat();
		
		m1.m02 = treeTex.getFloat();
		m1.m12 = treeTex.getFloat();
		m1.m22 = treeTex.getFloat();
		m1.m32 = treeTex.getFloat();
		
		m1.m03 = treeTex.getFloat();
		m1.m13 = treeTex.getFloat();
		m1.m23 = treeTex.getFloat();
		m1.m33 = treeTex.getFloat();
