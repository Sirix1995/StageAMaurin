...
//enh:end
	...
	public static class Pattern extends de.grogra.xl.impl.base.FieldListPattern
	{
		public Pattern ()
		{
			super (Ll.$TYPE, argument$FIELD);
		}

		public static void signature (@In @Out Ll n, float a)
		{
		}
	}
	...
	{
		state.localLength =  (getArgument (node, gs));
	}
}
