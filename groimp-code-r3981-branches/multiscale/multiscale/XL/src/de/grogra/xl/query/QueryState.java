...
public class QueryState
{
	...
	//yong - 30 mar 2012 - for macro state tracking
	private HashMap<Object, ObjectList> macroRefinementReferences;
	boolean forRefinementReferences;
	...
	public QueryState (Graph extent)
	{
		...
		macroRefinementReferences = new HashMap<Object, ObjectList>();
		//yong 30 mar 2012 - end
	}
	...
	//yong 15 Mar 2012 - trying to propogate across scale
	void propogateMatches()
	{
		graph.scaleNodes(this);
	}
	//yong - 15 Mar 2012 - end

	void findMatches
		(CompoundPattern pred, Pattern.Matcher matcher, Frame frame,
		 Variable[] variables, Object consumer, boolean forProduction, boolean forRef)
	{
		this.frame = frame;
		sp = 0;
		...
		//yong 30 mar 2012 - refinement references macro
		this.forRefinementReferences = forRef;
		//yong 30 mar 2012 - end
...
//	private static final MatchConsumer CONSUMER_REFINE_REF = new MatchConsumer ()
//	{
//		public void matchFound (QueryState qs, int arg)
//		{
//			qs.matchFoundImplRef (arg);
//		}
//	};
	
//	void matchFoundImplRef (int s)
//	{
//		int fp = vp - 1;
//		try
//		{
...
//	}
	...
	void matchFoundImpl (int s)
	{
		...
		{
			setVariables (s);
			//update refinement references
			if(forRefinementReferences)
			{
				nodeMap = CompoundPattern.Matcher.getNodeMap (this, matcherSp);
			...
			else
			{
				...
				else if ((pred.getOutParameter () >= 0) && (!forRefinementReferences))
				{
					switch (pred.getParameterType (pred.getOutParameter ()).getTypeId ())
					{
	/*!!
...
//!! *# End of generated code
	...
	//yong - 30 mar 2012 - macro refinement reference functionality
	/**
	 * Update refinement references for macro scale nodes.
	 * This occurs for each match during the lifetime of a query.
	 */
	public void updateMacroRefinementReferences()
	{
		//for each node matched, get the node data and thereafter the macro scale nodes
		for (NodeData d = getFirstNodeData (); d != null; d = (NodeData) d.listNext)
		{
	...
	/**
	 * Add new refinement reference to a macro node
	 * @param key
	 * @param newReference
	 */
	public void addMacroRefinementReference(Object key, Object newReference)
	{
	...
	/**
	 * Getter function for macro refinement references. 
	 * Used by class Producer to update/add references.
	 */
	public HashMap<Object,ObjectList> getMacroRefinementReferences()
	{
		return this.macroRefinementReferences;
	}
	//yong - 30 mar 2012 - end
}
