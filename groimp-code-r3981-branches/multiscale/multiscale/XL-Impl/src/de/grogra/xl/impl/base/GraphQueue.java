...
public abstract class GraphQueue extends HierarchicalQueue implements Queue, Executor
{
	...
	public static final class AddUndirectedEdgeDescriptor extends QueueDescriptor<GraphQueue>
	{
		...
		protected QueueDescriptor[] queuesToProcessAfter ()
		{
			return new QueueDescriptor[] {CONNECT_MACRO_DESCRIPTOR,DELETE_EDGE_DESCRIPTOR, DELETE_NODE_DESCRIPTOR};
		}
	...
	//yong 3 Apr 2012 - queue for macro connections
	public static final ConnectMacroDescriptor CONNECT_MACRO_DESCRIPTOR = new ConnectMacroDescriptor();
	
	public static final class ConnectMacroDescriptor extends QueueDescriptor<GraphQueue>
	{
		@Override
		protected QueueDescriptor[] queuesToProcessBefore ()
		{
	...
	//yong 3 Apr 2012 - queue for macro - END
	...
	public abstract void connectMacro(Object source, Object target, int edges);
	//yong 3 Apr 2012 - end
}
