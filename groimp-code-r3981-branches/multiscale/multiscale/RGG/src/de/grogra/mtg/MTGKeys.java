...
public class MTGKeys 
{
	...
	//Workbench state variables key strings
	public static final String MTG_SCALES_VISIBLE								= "scale visible";
	public static final String MTG_SCALES_CHANGED								= "scale changed";
