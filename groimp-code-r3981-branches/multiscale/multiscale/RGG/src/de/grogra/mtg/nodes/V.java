 ...
 * @since  2011-11-24
 */
public class V extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (V.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
