 ...
 * @since  2011-11-24
 */
public class G extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (G.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
