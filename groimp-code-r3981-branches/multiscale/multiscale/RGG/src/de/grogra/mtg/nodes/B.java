 ...
 * @since  2011-11-24
 */
public class B extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (B.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
