 ...
 * @since  2011-11-24
 */
public class O extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (O.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
