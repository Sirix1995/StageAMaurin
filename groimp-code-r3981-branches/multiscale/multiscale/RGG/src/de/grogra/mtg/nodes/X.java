 ...
 * @since  2011-11-24
 */
public class X extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (X.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
