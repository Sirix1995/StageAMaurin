 ...
 * @since  2011-11-24
 */
public class W extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (W.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
