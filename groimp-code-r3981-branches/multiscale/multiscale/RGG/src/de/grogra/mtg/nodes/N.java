 ...
 * @since  2011-11-24
 */
public class N extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (N.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
