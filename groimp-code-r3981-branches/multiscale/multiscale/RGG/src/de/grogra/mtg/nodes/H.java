 ...
 * @since  2011-11-24
 */
public class H extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (H.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
