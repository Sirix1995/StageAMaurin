 ...
 * @since  2011-11-24
 */
public class C extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (C.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
