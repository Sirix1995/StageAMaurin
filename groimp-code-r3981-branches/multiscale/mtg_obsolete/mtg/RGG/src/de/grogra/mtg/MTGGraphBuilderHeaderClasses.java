...
{	
	...
	private void processInfo(String[] tokens) throws MTGError.MTGGraphBuildException
	{
		...
		if(mtgClassesObj==null)
			rootNode.setObject(MTGKeys.MTG_CLASSES_KEYWORD_CLASSES, new ArrayList<MTGNodeDataClasses>());
		
		mtgClassesObj = rootNode.getObject(MTGKeys.MTG_CLASSES_KEYWORD_CLASSES);
		if(mtgClassesObj instanceof ArrayList)
		{
			ArrayList<MTGNodeDataClasses> mtgClasses = (ArrayList<MTGNodeDataClasses>)rootNode.getObject(MTGKeys.MTG_CLASSES_KEYWORD_CLASSES);
