 ...
 * @since  2011-11-24
 */
public class Z extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (Z.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
