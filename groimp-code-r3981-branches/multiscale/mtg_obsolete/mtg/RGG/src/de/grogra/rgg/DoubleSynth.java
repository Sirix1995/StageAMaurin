...
/**
 * Instances of <code>DoubleSynth</code> are used in the context of the method
 * {@link Library#synthesize(Object, ObjectToObjectGenerator, ObjectToDouble)}.
 ...
 * <code>evaluateDouble</code> yields the values of the synthesized attributes of
 ...
 *
 */
public final class DoubleSynth<T> implements de.grogra.xl.lang.VoidToDoubleGenerator
{
	/**
	 * The current object.
	 */
	...
	de.grogra.xl.util.DoubleList valuesList;
	int startIndex;
	 ...
	 */
	public void evaluateDouble (de.grogra.xl.lang.DoubleConsumer cons)
	{
	...
	/**
	 * This method is an alias for {@link #evaluateDouble}.
	 */
	public void values (de.grogra.xl.lang.DoubleConsumer cons)
	{
		evaluateDouble (cons);
	}
