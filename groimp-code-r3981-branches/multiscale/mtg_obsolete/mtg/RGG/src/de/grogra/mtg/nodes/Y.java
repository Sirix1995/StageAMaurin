 ...
 * @since  2011-11-24
 */
public class Y extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (Y.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
