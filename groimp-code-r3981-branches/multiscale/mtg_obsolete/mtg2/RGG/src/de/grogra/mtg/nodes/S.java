 ...
 * @since  2011-11-24
 */
public class S extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (S.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
