...
/**
 * Instances of <code>IntSynth</code> are used in the context of the method
 * {@link Library#synthesize(Object, ObjectToObjectGenerator, ObjectToInt)}.
 ...
 * <code>evaluateInt</code> yields the values of the synthesized attributes of
 ...
 *
 */
public final class IntSynth<T> implements de.grogra.xl.lang.VoidToIntGenerator
{
	/**
	 * The current object.
	 */
	...
	de.grogra.xl.util.IntList valuesList;
	int startIndex;
