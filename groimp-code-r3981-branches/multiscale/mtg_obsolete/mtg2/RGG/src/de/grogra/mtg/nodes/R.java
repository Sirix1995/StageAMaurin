 ...
 * @since  2011-11-24
 */
public class R extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (R.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
