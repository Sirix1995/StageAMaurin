 ...
 * @since  2011-11-24
 */
public class L extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (L.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
