 ...
 * @since  2011-11-24
 */
public class A extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (A.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
