...
public interface LSYTokenTypes {
	...
	// "\\register" = 231
	// "\\var" = 232
	int LITERAL_uniform = 233;
	int LITERAL_normal = 234;
	int LITERAL_binomial = 235;
	int LITERAL_negbinomial = 236;
	int LITERAL_poisson = 237;
	int LITERAL_distribution = 238;
	int LITERAL_table = 239;
	int LITERAL_generation = 240;
	int LITERAL_register = 241;
	int LITERAL_local = 242;
	int LITERAL_index = 243;
	int LITERAL_length = 244;
	int LITERAL_diameter = 245;
	int LITERAL_n_value = 246;
	int LITERAL_v_value = 247;
	int LITERAL_color = 248;
	int LITERAL_order = 249;
	int LITERAL_carbon = 250;
	int LITERAL_q_value = 251;
	int LITERAL_xcoordinate = 252;
	int LITERAL_ycoordinate = 253;
	int LITERAL_zcoordinate = 254;
	int LITERAL_function = 255;
	// "#" = 256
	// "##" = 257
	// "?" = 258
	// "&" = 259
	int LITERAL_if = 260;
	int LITERAL_sum = 261;
	int LITERAL_sumd = 262;
	int LITERAL_sump = 263;
}
