 ...
 * @since  2011-11-24
 */
public class Q extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (Q.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
