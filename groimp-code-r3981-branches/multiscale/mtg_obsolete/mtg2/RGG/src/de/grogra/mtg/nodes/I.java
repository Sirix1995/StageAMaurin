 ...
 * @since  2011-11-24
 */
public class I extends MTGNode{
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (I.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
