...
/*
 * Modifications for GroIMP-integration made by Ole Kniemeyer 2005/12/10
...
public class ChartPanel extends JPanel 
    ...
    public void paintComponent(Graphics g) {
        ...
        if (this.useBuffer) {
            ...
            if (this.refreshBuffer) {
            	...
            	// 2005/12/10: modified by Ole Kniemeyer
                if (scale)
                {
                	drawChart (true, chartArea);
                }
                else
                {
                	drawChart (false, new Rectangle2D.Double
	...
	// 2005/12/10: added by Ole Kniemeyer
    protected void drawChart (boolean scale, Rectangle2D bounds)
	{
        ...
        if (scale) {
            ...
            this.chart.draw(
                bufferG2, bounds, this.anchor, this.info
            );
