...
/**
 * Instances of <code>BooleanSynth</code> are used in the context of the method
 * {@link Library#synthesize(Object, ObjectToObjectGenerator, ObjectToBoolean)}.
 ...
 * <code>evaluateBoolean</code> yields the values of the synthesized attributes of
 ...
 *
 */
public final class BooleanSynth<T> implements de.grogra.xl.lang.VoidToBooleanGenerator
{
	/**
	 * The current object.
	 */
	...
	de.grogra.xl.util.BooleanList valuesList;
	int startIndex;
	 ...
	 */
	public void evaluateBoolean (de.grogra.xl.lang.BooleanConsumer cons)
	{
	...
	/**
	 * This method is an alias for {@link #evaluateBoolean}.
	 */
	public void values (de.grogra.xl.lang.BooleanConsumer cons)
	{
		evaluateBoolean (cons);
	}
