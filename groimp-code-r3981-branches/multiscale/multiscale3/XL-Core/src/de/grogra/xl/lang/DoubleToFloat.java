...
/**
 * Instances of <code>DoubleToFloat</code> represent functions
 ...
 * <code>DoubleToFloat f = double x => float</code>
 * <i>some expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface DoubleToFloat
{
	/**
