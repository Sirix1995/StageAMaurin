...
/**
 * Instances of <code>ObjectToObjectGenerator</code> represent
 ...
 * <code>ObjectToObjectGenerator f = K x => V*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ObjectToObjectGenerator<K,V>
{
	/**
	 ...
	 */
	void evaluateObject (ObjectConsumer<? super V> cons, K x);
}
