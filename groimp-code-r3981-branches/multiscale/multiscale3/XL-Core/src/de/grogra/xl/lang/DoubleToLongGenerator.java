...
/**
 * Instances of <code>DoubleToLongGenerator</code> represent
 ...
 * <code>DoubleToLongGenerator f = double x => long*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface DoubleToLongGenerator
{
	/**
	 ...
	 */
	void evaluateLong (LongConsumer cons, double x);
}
