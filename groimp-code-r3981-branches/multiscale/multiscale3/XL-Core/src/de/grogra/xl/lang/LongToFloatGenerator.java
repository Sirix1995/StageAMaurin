...
/**
 * Instances of <code>LongToFloatGenerator</code> represent
 ...
 * <code>LongToFloatGenerator f = long x => float*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface LongToFloatGenerator
{
	/**
	 ...
	 */
	void evaluateFloat (FloatConsumer cons, long x);
}
