...
/**
 * Instances of <code>IntToCharGenerator</code> represent
 ...
 * <code>IntToCharGenerator f = int x => char*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface IntToCharGenerator
{
	/**
	 ...
	 */
	void evaluateChar (CharConsumer cons, int x);
}
