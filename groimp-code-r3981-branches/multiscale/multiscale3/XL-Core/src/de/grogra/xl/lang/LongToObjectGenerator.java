...
/**
 * Instances of <code>LongToObjectGenerator</code> represent
 ...
 * <code>LongToObjectGenerator f = long x => V*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface LongToObjectGenerator<V>
{
	/**
	 ...
	 */
	void evaluateObject (ObjectConsumer<? super V> cons, long x);
}
