...
/**
 * Instances of <code>BooleanToByteGenerator</code> represent
 ...
 * <code>BooleanToByteGenerator f = boolean x => byte*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface BooleanToByteGenerator
{
	/**
	 ...
	 */
	void evaluateByte (ByteConsumer cons, boolean x);
}
