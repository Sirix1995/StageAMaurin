...
/**
 * Instances of <code>ShortToVoidGenerator</code> represent
 * generator functions which take <code>short</code>s as input
 ...
 * <code>ShortToVoidGenerator f = short x => void*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ShortToVoidGenerator
{
	/**
	 ...
	 */
	void evaluateVoid (VoidConsumer cons, short x);
}
