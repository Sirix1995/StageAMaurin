...
/**
 * Instances of <code>BooleanToIntGenerator</code> represent
 ...
 * <code>BooleanToIntGenerator f = boolean x => int*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface BooleanToIntGenerator
{
	/**
	 ...
	 */
	void evaluateInt (IntConsumer cons, boolean x);
}
