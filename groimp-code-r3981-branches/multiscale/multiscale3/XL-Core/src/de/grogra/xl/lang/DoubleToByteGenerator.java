...
/**
 * Instances of <code>DoubleToByteGenerator</code> represent
 ...
 * <code>DoubleToByteGenerator f = double x => byte*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface DoubleToByteGenerator
{
	/**
	 ...
	 */
	void evaluateByte (ByteConsumer cons, double x);
}
