...
/**
 * Instances of <code>BooleanToDouble</code> represent functions
 ...
 * <code>BooleanToDouble f = boolean x => double</code>
 * <i>some expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface BooleanToDouble
{
	/**
	 ...
	 */
	double evaluateDouble (boolean x);
}
