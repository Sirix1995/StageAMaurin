...
/**
 * Instances of <code>ByteToByteGenerator</code> represent
 ...
 * <code>ByteToByteGenerator f = byte x => byte*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ByteToByteGenerator
{
	/**
	 ...
	 */
	void evaluateByte (ByteConsumer cons, byte x);
}
