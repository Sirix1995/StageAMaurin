...
/**
 * Instances of <code>FloatToFloatGenerator</code> represent
 ...
 * <code>FloatToFloatGenerator f = float x => float*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface FloatToFloatGenerator
{
	/**
	 ...
	 */
	void evaluateFloat (FloatConsumer cons, float x);
}
