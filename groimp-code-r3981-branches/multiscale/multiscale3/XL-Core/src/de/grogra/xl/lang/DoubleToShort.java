...
/**
 * Instances of <code>DoubleToShort</code> represent functions
 ...
 * <code>DoubleToShort f = double x => short</code>
 * <i>some expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface DoubleToShort
{
	/**
