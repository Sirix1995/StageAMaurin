...
/**
 * Instances of <code>ByteToCharGenerator</code> represent
 ...
 * <code>ByteToCharGenerator f = byte x => char*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ByteToCharGenerator
{
	/**
	 ...
	 */
	void evaluateChar (CharConsumer cons, byte x);
}
