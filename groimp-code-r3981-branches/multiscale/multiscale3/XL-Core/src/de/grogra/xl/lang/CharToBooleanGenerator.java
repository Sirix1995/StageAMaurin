...
/**
 * Instances of <code>CharToBooleanGenerator</code> represent
 ...
 * <code>CharToBooleanGenerator f = char x => boolean*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface CharToBooleanGenerator
{
	/**
	 ...
	 */
	void evaluateBoolean (BooleanConsumer cons, char x);
}
