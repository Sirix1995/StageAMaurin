...
/**
 * <code>ObjectConsumer</code> is a callback interface. Its instances
 * receive values of type <code>T</code> by invocation of their
 * {@link #consume} method.
 * <p>
 * This interface is primarily intended for
 * the declaration of generator methods of the XL programming language
 * with return type <code>T</code>. Such methods have an additional
 * parameter of type <code>ObjectConsumer</code> to which they send the
 * generated values. 
 * <p>
...
{
	/**
	 * Receives a value of type <code>T</code>.
	 * 
	 */
	void consume (
		T value
