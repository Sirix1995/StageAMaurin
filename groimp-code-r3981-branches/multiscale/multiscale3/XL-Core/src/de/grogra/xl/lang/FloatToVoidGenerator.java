...
/**
 * Instances of <code>FloatToVoidGenerator</code> represent
 * generator functions which take <code>float</code>s as input
 ...
 * <code>FloatToVoidGenerator f = float x => void*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface FloatToVoidGenerator
{
	/**
	 ...
	 */
	void evaluateVoid (VoidConsumer cons, float x);
}
