...
de.grogra.xl.lang.VoidToObjectGenerator<E>
{
	...
	/**
     * Removes all the elements beginning from index from this list.
     * @return true if elements are removed, false otherwise
     */
	public boolean clear (int index)
	{
		...
		int numToRemove = currSize - index;
		if(numToRemove > 0)
		{
			modCount++;
			clear (elements, index, numToRemove);
			size = index;
			return true;
		}
