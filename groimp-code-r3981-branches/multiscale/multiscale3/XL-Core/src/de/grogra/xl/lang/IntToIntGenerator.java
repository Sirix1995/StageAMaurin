...
/**
 * Instances of <code>IntToIntGenerator</code> represent
 ...
 * <code>IntToIntGenerator f = int x => int*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface IntToIntGenerator
{
	/**
	 ...
	 */
	void evaluateInt (IntConsumer cons, int x);
}
