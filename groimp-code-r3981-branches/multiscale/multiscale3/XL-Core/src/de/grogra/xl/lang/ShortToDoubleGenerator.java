...
/**
 * Instances of <code>ShortToDoubleGenerator</code> represent
 ...
 * <code>ShortToDoubleGenerator f = short x => double*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ShortToDoubleGenerator
{
	/**
	 ...
	 */
	void evaluateDouble (DoubleConsumer cons, short x);
}
