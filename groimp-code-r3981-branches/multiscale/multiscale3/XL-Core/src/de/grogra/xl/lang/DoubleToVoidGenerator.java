...
/**
 * Instances of <code>DoubleToVoidGenerator</code> represent
 * generator functions which take <code>double</code>s as input
 ...
 * <code>DoubleToVoidGenerator f = double x => void*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface DoubleToVoidGenerator
{
	/**
	 ...
	 */
	void evaluateVoid (VoidConsumer cons, double x);
}
