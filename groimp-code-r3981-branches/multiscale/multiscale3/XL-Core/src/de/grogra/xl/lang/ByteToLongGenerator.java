...
/**
 * Instances of <code>ByteToLongGenerator</code> represent
 ...
 * <code>ByteToLongGenerator f = byte x => long*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ByteToLongGenerator
{
	/**
	 ...
	 */
	void evaluateLong (LongConsumer cons, byte x);
}
