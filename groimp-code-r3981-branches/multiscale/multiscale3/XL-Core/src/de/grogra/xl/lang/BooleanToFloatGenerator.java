...
/**
 * Instances of <code>BooleanToFloatGenerator</code> represent
 ...
 * <code>BooleanToFloatGenerator f = boolean x => float*</code>
...
public interface BooleanToFloatGenerator
{
	 ...
	 */
	void evaluateFloat (FloatConsumer cons, boolean x);
}
