...
/**
 * Instances of <code>ByteToFloatGenerator</code> represent
 ...
 * <code>ByteToFloatGenerator f = byte x => float*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ByteToFloatGenerator
{
	/**
	 ...
	 */
	void evaluateFloat (FloatConsumer cons, byte x);
}
