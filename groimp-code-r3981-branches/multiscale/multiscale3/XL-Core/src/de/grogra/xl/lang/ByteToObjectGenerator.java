...
/**
 * Instances of <code>ByteToObjectGenerator</code> represent
 ...
 * <code>ByteToObjectGenerator f = byte x => V*</code>
...
public interface ByteToObjectGenerator<V>
{
	 ...
	 */
	void evaluateObject (ObjectConsumer<? super V> cons, byte x);
}
