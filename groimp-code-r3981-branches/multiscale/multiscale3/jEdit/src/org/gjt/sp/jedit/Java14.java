...
public class Java14
{
	...
	*/
		...
		// 2006/08/11: modified by Ole Kniemeyer
		
		// this would remove standard Swing keyboard handling, so comment out
		// KeyboardFocusManager.setCurrentKeyboardFocusManager(
		//	new MyFocusManager());

		// instead add MyFocusManager as postprocessor
		KeyboardFocusManager.getCurrentKeyboardFocusManager ()
			.addKeyEventPostProcessor (new MyFocusManager ());
