...
public final class EnumerateNodesPattern extends BuiltInPattern
{

	EnumerateNodesPattern (Type type)
	{
	...
	{
		final Type type = getParameterType (0);
		return new Matcher (50)
		{
			@Override
			public void findMatches
				(QueryState qs, MatchConsumer consumer, int arg)
			{
				qs.graph.enumerateNodes (type, qs, 0, consumer, arg);
			}
			
			@Override
			public String toString ()
			{
				return "EnumerateNodes[" + type.getName () + ']';
			}
		};
	}
