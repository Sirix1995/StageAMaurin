...
/**
 * Instances of <code>FloatToBoolean</code> represent functions
 ...
 * <code>FloatToBoolean f = float x => boolean</code>
 * <i>some expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface FloatToBoolean
{
	/**
	 ...
	 */
	boolean evaluateBoolean (float x);
}
