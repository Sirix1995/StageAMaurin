...
/**
 * Instances of <code>ByteToDoubleGenerator</code> represent
 ...
 * <code>ByteToDoubleGenerator f = byte x => double*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ByteToDoubleGenerator
{
	/**
	 ...
	 */
	void evaluateDouble (DoubleConsumer cons, byte x);
}
