...
/**
 * Instances of <code>CharToByteGenerator</code> represent
 ...
 * <code>CharToByteGenerator f = char x => byte*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface CharToByteGenerator
{
	/**
	 ...
	 */
	void evaluateByte (ByteConsumer cons, char x);
}
