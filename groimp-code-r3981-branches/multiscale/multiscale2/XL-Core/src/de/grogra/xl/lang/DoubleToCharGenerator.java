...
/**
 * Instances of <code>DoubleToCharGenerator</code> represent
 ...
 * <code>DoubleToCharGenerator f = double x => char*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface DoubleToCharGenerator
{
	/**
	 ...
	 */
	void evaluateChar (CharConsumer cons, double x);
}
