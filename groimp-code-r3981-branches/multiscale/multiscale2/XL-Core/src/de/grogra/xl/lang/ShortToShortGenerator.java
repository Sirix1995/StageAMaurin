...
/**
 * Instances of <code>ShortToShortGenerator</code> represent
 ...
 * <code>ShortToShortGenerator f = short x => short*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ShortToShortGenerator
{
	/**
	 ...
	 */
	void evaluateShort (ShortConsumer cons, short x);
}
