...
/**
 * Instances of <code>ShortToBoolean</code> represent functions
 ...
 * <code>ShortToBoolean f = short x => boolean</code>
 * <i>some expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ShortToBoolean
{
	/**
	 ...
	 */
	boolean evaluateBoolean (short x);
}
