...
/**
 * <code>IntAggregateState</code> is the subinterface of
 * {@link AggregateState} that is used for aggregate methods with return
 * value of type int. Its precise usage is specified by the
 * XL programming language.
 *
 * @author Ole Kniemeyer
 */
public interface IntAggregateState extends AggregateState
{
	/**
