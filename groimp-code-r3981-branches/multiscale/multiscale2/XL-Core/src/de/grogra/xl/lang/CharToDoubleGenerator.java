...
/**
 * Instances of <code>CharToDoubleGenerator</code> represent
 ...
 * <code>CharToDoubleGenerator f = char x => double*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface CharToDoubleGenerator
{
	/**
	 ...
	 */
	void evaluateDouble (DoubleConsumer cons, char x);
}
