...
/**
 * <code>LongAggregateState</code> is the subinterface of
 * {@link AggregateState} that is used for aggregate methods with return
 * value of type long. Its precise usage is specified by the
 * XL programming language.
 *
 * @author Ole Kniemeyer
 */
public interface LongAggregateState extends AggregateState
{
	/**
