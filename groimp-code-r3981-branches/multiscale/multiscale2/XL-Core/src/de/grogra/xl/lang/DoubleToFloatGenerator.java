...
/**
 * Instances of <code>DoubleToFloatGenerator</code> represent
 ...
 * <code>DoubleToFloatGenerator f = double x => float*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface DoubleToFloatGenerator
{
	/**
	 ...
	 */
	void evaluateFloat (FloatConsumer cons, double x);
}
