...
/**
 * Instances of <code>IntToFloatGenerator</code> represent
 ...
 * <code>IntToFloatGenerator f = int x => float*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface IntToFloatGenerator
{
	/**
	 ...
	 */
	void evaluateFloat (FloatConsumer cons, int x);
}
