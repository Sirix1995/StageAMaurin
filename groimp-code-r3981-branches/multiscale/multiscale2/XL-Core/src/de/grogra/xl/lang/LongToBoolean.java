...
/**
 * Instances of <code>LongToBoolean</code> represent functions
 ...
 * <code>LongToBoolean f = long x => boolean</code>
 * <i>some expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface LongToBoolean
{
	/**
	 ...
	 */
	boolean evaluateBoolean (long x);
}
