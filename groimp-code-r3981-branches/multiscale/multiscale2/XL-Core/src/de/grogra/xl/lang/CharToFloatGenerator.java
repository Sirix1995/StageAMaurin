...
/**
 * Instances of <code>CharToFloatGenerator</code> represent
 ...
 * <code>CharToFloatGenerator f = char x => float*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface CharToFloatGenerator
{
	/**
	 ...
	 */
	void evaluateFloat (FloatConsumer cons, char x);
}
