...
/**
 * Instances of <code>FloatToIntGenerator</code> represent
 ...
 * <code>FloatToIntGenerator f = float x => int*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface FloatToIntGenerator
{
	/**
	 ...
	 */
	void evaluateInt (IntConsumer cons, float x);
}
