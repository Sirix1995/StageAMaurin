...
/**
 * A <code>IntList</code> represents a list of <code>int</code> values.
...
public class IntList
	implements
Cloneable, java.io.Serializable, de.grogra.xl.lang.IntConsumer,
de.grogra.xl.lang.VoidToIntGenerator
{
	...
	/**
	 * Constructs a new <code>IntList</code> with a given initial capacity.
	 *
	 * @param capacity the initial capacity
	 */
	public IntList (int capacity)
	{
		elements = new int[Math.max (capacity, 8)];
	}


	/**
	 * Constructs a new <code>IntList</code>.
	 */
	public IntList ()
	{
		this (16);
	...
	/**
	 * Constructs a new <code>IntList</code> whose elements are
	...
	public Object clone ()
	{
		try
		{
			...
			c.elements = new int[Math.max (size, 8)];
	...
	public void ensureCapacity (int capacity)
	{
		...
		{
			int[] a = new int[Math.max (capacity,
											elements.length * 2)];
	...
	public void trimToSize ()
	{
		if (size < elements.length)
		{
			...
			{
				arraycopy (elements, 0, elements = new int[size], 0, size);
			}
		}
	}
	 ...
	 * yet contained as reported by {@link #contains(int)}.
	 *
	 * @param o the value to add
	 */
	...
	{
		return (index < size) ? (int) elements[index] : 0;
	}
	...
	{
		return (index > 0) ? (int) elements[size - index] : 0;
	}
	...
	public void writeTo (java.nio.IntBuffer out)
	{
	...
	public static void arraycopy (int[] src, int srcIndex,
	...
	public static void clear (int[] array, int index, int length)
	{
		...
		else
		{
			while (length > 0)
			{
				...
				arraycopy (INT_NULL, 0, array, index, n);
				length -= n;
				index += n;
			}
		}
	 ...
	 */
	public void evaluateInt (de.grogra.xl.lang.IntConsumer cons)
	{
		for (int i = 0; i < size; i++)
		{
			cons.consume ((int) elements[i]);
		}
	}

	/**
	 * This method is an alias for {@link #evaluateInt}.
	 */
	public void values (de.grogra.xl.lang.IntConsumer cons)
	{
		evaluateInt (cons);
	}
