...
/**
 * Instances of <code>FloatToDoubleGenerator</code> represent
 ...
 * <code>FloatToDoubleGenerator f = float x => double*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface FloatToDoubleGenerator
{
	/**
	 ...
	 */
	void evaluateDouble (DoubleConsumer cons, float x);
}
