...
/**
 * Instances of <code>ObjectToBoolean</code> represent functions
 * which take <code>K</code>s as input and return values of
 * type <code>boolean</code>. Such instances are created by
 * lambda expressions of the XL programming language, e.g.,
 * <code>ObjectToBoolean f = K x => boolean</code>
 * <i>some expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ObjectToBoolean<K>
{
	/**
