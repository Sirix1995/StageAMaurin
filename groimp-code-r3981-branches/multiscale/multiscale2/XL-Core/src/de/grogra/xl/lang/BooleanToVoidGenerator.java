...
/**
 * Instances of <code>BooleanToVoidGenerator</code> represent
 * generator functions which take <code>boolean</code>s as input
 * and yield sequences of values of
 * type <code>void</code>. Such instances are created by
 * lambda expressions of the XL programming language, e.g.,
 * <code>BooleanToVoidGenerator f = boolean x => void*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface BooleanToVoidGenerator
{
	/**
	 ...
	 */
	void evaluateVoid (VoidConsumer cons, boolean x);
}
