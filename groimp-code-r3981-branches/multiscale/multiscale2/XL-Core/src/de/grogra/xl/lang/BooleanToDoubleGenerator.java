...
/**
 * Instances of <code>BooleanToDoubleGenerator</code> represent
 ...
 * <code>BooleanToDoubleGenerator f = boolean x => double*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface BooleanToDoubleGenerator
{
	/**
	 ...
	 */
	void evaluateDouble (DoubleConsumer cons, boolean x);
}
