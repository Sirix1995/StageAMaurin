...
/**
 * Instances of <code>IntToVoidGenerator</code> represent
 ...
 * <code>IntToVoidGenerator f = int x => void*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface IntToVoidGenerator
{
	/**
	 ...
	 */
	void evaluateVoid (VoidConsumer cons, int x);
}
