...
/**
 * Instances of <code>FloatToBooleanGenerator</code> represent
 ...
 * <code>FloatToBooleanGenerator f = float x => boolean*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface FloatToBooleanGenerator
{
	/**
	 ...
	 */
	void evaluateBoolean (BooleanConsumer cons, float x);
}
