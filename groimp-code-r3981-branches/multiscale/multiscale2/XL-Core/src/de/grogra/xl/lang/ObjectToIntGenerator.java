...
/**
 * Instances of <code>ObjectToIntGenerator</code> represent
 ...
 * <code>ObjectToIntGenerator f = K x => int*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ObjectToIntGenerator<K>
{
	/**
	 ...
	 */
	void evaluateInt (IntConsumer cons, K x);
}
