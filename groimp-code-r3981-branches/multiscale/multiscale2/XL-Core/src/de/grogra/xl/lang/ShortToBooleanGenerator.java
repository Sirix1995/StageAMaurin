...
/**
 * Instances of <code>ShortToBooleanGenerator</code> represent
 ...
 * <code>ShortToBooleanGenerator f = short x => boolean*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ShortToBooleanGenerator
{
	/**
	 ...
	 */
	void evaluateBoolean (BooleanConsumer cons, short x);
}
