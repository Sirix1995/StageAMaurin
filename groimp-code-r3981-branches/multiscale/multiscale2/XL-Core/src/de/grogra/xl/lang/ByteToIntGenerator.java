...
/**
 * Instances of <code>ByteToIntGenerator</code> represent
 ...
 * <code>ByteToIntGenerator f = byte x => int*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ByteToIntGenerator
{
	/**
	 ...
	 */
	void evaluateInt (IntConsumer cons, byte x);
}
