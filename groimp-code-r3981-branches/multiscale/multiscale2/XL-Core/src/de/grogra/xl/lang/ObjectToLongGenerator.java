...
/**
 * Instances of <code>ObjectToLongGenerator</code> represent
 ...
 * <code>ObjectToLongGenerator f = K x => long*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ObjectToLongGenerator<K>
{
	/**
	 ...
	 */
	void evaluateLong (LongConsumer cons, K x);
}
