...
/**
 * Instances of <code>ShortToObjectGenerator</code> represent
 ...
 * <code>ShortToObjectGenerator f = short x => V*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ShortToObjectGenerator<V>
{
	/**
	 ...
	 */
	void evaluateObject (ObjectConsumer<? super V> cons, short x);
}
