...
/**
 * Instances of <code>BooleanToObjectGenerator</code> represent
 ...
 * <code>BooleanToObjectGenerator f = boolean x => V*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface BooleanToObjectGenerator<V>
{
	/**
	 ...
	 */
	void evaluateObject (ObjectConsumer<? super V> cons, boolean x);
}
