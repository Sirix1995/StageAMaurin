...
/**
 * Instances of <code>ShortToFloatGenerator</code> represent
 ...
 * <code>ShortToFloatGenerator f = short x => float*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ShortToFloatGenerator
{
	/**
	 ...
	 */
	void evaluateFloat (FloatConsumer cons, short x);
}
