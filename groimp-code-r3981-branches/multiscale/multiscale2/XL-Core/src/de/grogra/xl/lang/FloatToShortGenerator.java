...
/**
 * Instances of <code>FloatToShortGenerator</code> represent
 ...
 * <code>FloatToShortGenerator f = float x => short*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface FloatToShortGenerator
{
	/**
	 ...
	 */
	void evaluateShort (ShortConsumer cons, float x);
}
