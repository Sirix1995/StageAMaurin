...
/**
 * Instances of <code>FloatToLongGenerator</code> represent
 ...
 * <code>FloatToLongGenerator f = float x => long*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface FloatToLongGenerator
{
	/**
	 ...
	 */
	void evaluateLong (LongConsumer cons, float x);
}
