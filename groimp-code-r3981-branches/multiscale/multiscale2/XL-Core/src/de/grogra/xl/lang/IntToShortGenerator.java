...
/**
 * Instances of <code>IntToShortGenerator</code> represent
 ...
 * <code>IntToShortGenerator f = int x => short*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface IntToShortGenerator
{
	/**
	 ...
	 */
	void evaluateShort (ShortConsumer cons, int x);
}
