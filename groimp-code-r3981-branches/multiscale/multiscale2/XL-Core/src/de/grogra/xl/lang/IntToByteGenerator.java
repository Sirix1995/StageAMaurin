...
/**
 * Instances of <code>IntToByteGenerator</code> represent
 ...
 * <code>IntToByteGenerator f = int x => byte*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface IntToByteGenerator
{
	/**
	 ...
	 */
	void evaluateByte (ByteConsumer cons, int x);
}
