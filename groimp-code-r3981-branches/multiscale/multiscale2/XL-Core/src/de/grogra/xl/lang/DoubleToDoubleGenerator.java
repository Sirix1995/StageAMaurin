...
/**
 * Instances of <code>DoubleToDoubleGenerator</code> represent
 ...
 * <code>DoubleToDoubleGenerator f = double x => double*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface DoubleToDoubleGenerator
{
	/**
	 ...
	 */
	void evaluateDouble (DoubleConsumer cons, double x);
}
