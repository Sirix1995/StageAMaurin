...
/**
 * Instances of <code>CharToObjectGenerator</code> represent
 ...
 * <code>CharToObjectGenerator f = char x => V*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface CharToObjectGenerator<V>
{
	/**
	 ...
	 */
	void evaluateObject (ObjectConsumer<? super V> cons, char x);
}
