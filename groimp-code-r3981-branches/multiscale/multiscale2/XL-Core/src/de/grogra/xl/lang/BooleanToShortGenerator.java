...
/**
 * Instances of <code>BooleanToShortGenerator</code> represent
 ...
 * <code>BooleanToShortGenerator f = boolean x => short*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface BooleanToShortGenerator
{
	/**
	 ...
	 */
	void evaluateShort (ShortConsumer cons, boolean x);
}
