...
/**
 * Instances of <code>ObjectToDouble</code> represent functions
 ...
 * <code>ObjectToDouble f = K x => double</code>
 * <i>some expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ObjectToDouble<K>
{
	/**
