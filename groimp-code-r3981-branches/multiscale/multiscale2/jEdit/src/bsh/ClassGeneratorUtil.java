...
/*
 * Fitted for ASM 2.2 by Ole Kniemeyer 2005/12/12
...
public class ClassGeneratorUtil implements Opcodes 
{
	...
	*/
	public byte [] generateClass() 
	{
		...
		cw.visit( V1_4, classMods, fqClassName, null, superClassName, 
			interfaceNames);
	...
	*/
	...
	{
		cw.visitField( modifiers, fieldName, type, null, null/*value*/ );
	}
	...
	*/
		...
		String returnType, String[] paramTypes, int modifiers, ClassWriter cw ) 
	{
		...
		MethodVisitor cv = cw.visitMethod( 
			modifiers, methodName, methodDescriptor, null, exceptions );
	...
	*/
		...
		int index, String [] paramTypes, int modifiers, ClassWriter cw ) 
	{
		...
		MethodVisitor cv = 
			cw.visitMethod( modifiers, "<init>", methodDescriptor, null, exceptions );
	...
	*/
	void generateConstructorSwitch( 
		int consIndex, int argsVar, int consArgsVar, MethodVisitor cv )
	{
	...
	*/
	static void doSwitchBranch( 
		...
		Label endLabel, Label [] labels, int consArgsVar, MethodVisitor cv
	)
	{
	...
	*/
		...
		String returnType, String [] paramTypes, int modifiers, ClassWriter cw) 
	{
		...
		// Add method body
		MethodVisitor cv = cw.visitMethod( 
			modifiers, "_bshSuper"+methodName, methodDescriptor, null, exceptions );
   ...
   */
	public static void generateReturnCode (
		String returnType, MethodVisitor cv ) 
	{
		if ( returnType.equals("V") ) 
		{
			cv.visitInsn(POP);
