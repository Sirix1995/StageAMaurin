 ...
 */
public class View extends de.grogra.ext.jedit.ViewBase implements EBComponent
{
	// 2005/08/17: superclass changed from JFrame to ViewBase by Ole Kniemeyer
	...
	public ViewConfig getViewConfig()
	{
		...
		config.extState = 0; // GUIUtilities.getExtendedState(this);
	...
	void close()
	{
		// 2005/08/17: commented out by Ole Kniemeyer
		...
		SearchDialog sd = SearchDialog.getSearchDialog (this);
		if (sd != null)
		{
			sd.dispose ();
		}
