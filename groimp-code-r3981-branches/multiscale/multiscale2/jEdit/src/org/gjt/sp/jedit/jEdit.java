...
public class jEdit
{
	...
	public static View newView(View view, Buffer buffer, View.ViewConfig config)
	{
		...
		*/
			...
			// show tip of the day
			// 2005/08/17: modified out by Ole Kniemeyer
			if(!firstViewOpened)
			{
	...
	private static void initMisc()
	{
		...
		// 2005/08/17: commented out by Ole Kniemeyer
		// (protocol registered via plugin.xml)
	/*
...
loop:		for(int i = 0; i < list.length; i++)
	...
	//{{{ closeView() method
	// 2005/08/17: made public by Ole Kniemeyer
	/**
	 * closeView() used by exit().
	 */
	public static void closeView(View view, boolean callExit)
	{
		PerspectiveManager.setPerspectiveDirty(true);
