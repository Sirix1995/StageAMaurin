...
<!--
  <head>
   ...
   <meta name="modified"     		content="5 July 2006" />
   <meta name="description" content="XSLT stylesheet to convert X3D files to VRML97 format, using x3d-3.0.dtd form." />
   <meta name="url"         content="http://www.web3d.org/x3d/content/X3dToVrml97.xslt" />
  </head>
...
<xsl:output method="text" encoding="utf-8" omit-xml-declaration="yes" media-type="model/vrml" indent="no" cdata-section-elements="Script"/>
...
<xsl:template match="/">
  ...
  <!-- will need profile/components here for Classic VRML encoding, also avoid double error checking -->
...
EXTERNPROTO IndexedQuadSet [
  ...
  "/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#IndexedQuadSet"
  "c:/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#IndexedQuadSet"
  ...
  "/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.x3d#IndexedQuadSet"
  "c:/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.x3d#IndexedQuadSet"
...
EXTERNPROTO QuadSet [
  ...
  "/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#QuadSet"
  "c:/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#QuadSet"
  "http://www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#QuadSet"
  "CADGeometryPrototypes.x3d#QuadSet"
  "/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.x3d#QuadSet"
  "c:/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.x3d#QuadSet"
...
EXTERNPROTO CADAssembly [
  ...
  "/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#CADAssembly"
  "c:/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#CADAssembly"
  ...
  "/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.x3d#CADAssembly"
  "c:/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.x3d#CADAssembly"
...
EXTERNPROTO CADFace [
  ...
  "/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#CADFace"
  "c:/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#CADFace"
  "http://www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#CADFace"
  "CADGeometryPrototypes.x3d#CADFace"
  "/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.x3d#CADFace"
  "c:/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.x3d#CADFace"
...
EXTERNPROTO CADLayer [
  ...
  "/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#CADLayer"
  "c:/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#CADLayer"
  "http://www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#CADLayer"
  "CADGeometryPrototypes.x3d#CADLayer"
  "/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.x3d#CADLayer"
  "c:/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.x3d#CADLayer"
...
EXTERNPROTO CADPart [
  ...
  "/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#CADPart"
  "c:/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#CADPart"
  "http://www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.wrl#CADPart"
  "CADGeometryPrototypes.x3d#CADPart"
  "/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.x3d#CADPart"
  "c:/www.web3d.org/x3d/content/examples/Basic/CAD/CADGeometryPrototypes.x3d#CADPart"
...
EXTERNPROTO XvlShell [
  ...
  "./XvlShellProtoDeclare.wrl#XvlShell"
  "C:/www.web3d.org/x3d/content/examples/Basic/LatticeXvl/XvlShellProtoDeclare.wrl#XvlShell"
  "/www.web3d.org/x3d/content/examples/Basic/LatticeXvl/XvlShellProtoDeclare.wrl#XvlShell"
...
EXTERNPROTO EspduTransform [
  ...
  "/www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/EspduTransformPrototypes.wrl#EspduTransform"
  ...
  "/www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/EspduTransformPrototypes.x3d#EspduTransform"
  ...
  "file:///c:/www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/EspduTransformPrototypes.x3d#EspduTransform"
]
]]>
    </xsl:if>
...
EXTERNPROTO ReceiverPdu [
  ...
  "/www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/RadioCommunicationsPrototypes.wrl#ReceiverPdu"
  ...
  "/www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/RadioCommunicationsPrototypes.x3d#ReceiverPdu"
  ...
  "file:///c:/www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/RadioCommunicationsPrototypes.x3d#ReceiverPdu"
]
]]>
    </xsl:if>
...
EXTERNPROTO SignalPdu [
  ...
  "/www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/RadioCommunicationsPrototypes.wrl#SignalPdu"
  ...
  "/www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/RadioCommunicationsPrototypes.x3d#SignalPdu"
  ...
  "file:///c:/www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/RadioCommunicationsPrototypes.x3d#SignalPdu"
]
]]>
    </xsl:if>
...
EXTERNPROTO TransmitterPdu [
  ...
  "/www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/RadioCommunicationsPrototypes.wrl#TransmitterPdu"
  ...
  "/www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/RadioCommunicationsPrototypes.x3d#TransmitterPdu"
  ...
  "file:///c:/www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/RadioCommunicationsPrototypes.x3d#TransmitterPdu"
]
]]>
    </xsl:if>
    <!--========================================-->
...
<xsl:template match="component">
  ...
  <xsl:if test="not((@level='1') or (@level='2') or (@level='3') or (@level='4'))">
    <xsl:call-template name="output-error">
      <xsl:with-param name="errorString">
        ...
        <xsl:value-of select="@level"/>
        <xsl:text>'/&gt; (allowed range of values: 1..4)</xsl:text>
      </xsl:with-param>
      <xsl:with-param name="node" select="local-name()"/>
    </xsl:call-template>
  </xsl:if>
...
<xsl:template match="meta">
  ...
  <xsl:if test="(@name='url' and (contains(@content,'.wrl') and not(contains(@content,'.x3d'))))">
    <xsl:call-template name="output-warning">
      <xsl:with-param name="warningString">
        <xsl:text>&lt;meta name='url' /&gt; content ends with .wrl rather than .x3d</xsl:text>
      </xsl:with-param>
      <xsl:with-param name="node" select="local-name()"/>
    </xsl:call-template>
  </xsl:if>
  <xsl:if test="(@name='identifier' and ../meta[@name='title']/@content and not(contains(@content,../meta[@name='title']/@content)))">
    <xsl:call-template name="output-warning">
      <xsl:with-param name="warningString">
        <xsl:text>&lt;meta name='identifier'/&gt; title doesn't match &lt;meta name='title' content='</xsl:text>
  ...
  <xsl:if test="@name='url' and (contains(@content, 'http://www.web3d.org/x3d/content/examples/Savage/') or contains(@content, 'http://www.web3d.org/x3d/content/examples/Savage/'))">
    <xsl:call-template name="output-warning">
      <xsl:with-param name="warningString">
        <xsl:text>&lt;meta name='url'/&gt; website location incorrect, should be 'http://web.nps.navy.mil/~brutzman/Savage/' rather than content='</xsl:text>
  ...
  <xsl:if test="@name='error'">
    <xsl:call-template name="output-error">
      <xsl:with-param name="errorString">
        <xsl:text>&lt;meta name='error' content='</xsl:text>
        <xsl:value-of select="@content"/>
        <xsl:text>'/&gt;</xsl:text>
      </xsl:with-param>
      <xsl:with-param name="node" select="local-name()"/>
  ...
  <xsl:if test="@name='warning'">
    <xsl:call-template name="output-warning">
      <xsl:with-param name="warningString">
        <xsl:text>&lt;meta name='warning' content='</xsl:text>
        <xsl:value-of select="@content"/>
          <xsl:text>'/&gt;</xsl:text>
      </xsl:with-param>
      <xsl:with-param name="node" select="local-name()"/>
  ...
  <xsl:if test="@name='hint'">
    <xsl:call-template name="output-hint">
      <xsl:with-param name="hintString">
        <xsl:text>&lt;meta name='hint' content='</xsl:text>
        <xsl:value-of select="@content"/>
          <xsl:text>'/&gt;</xsl:text>
      </xsl:with-param>
      <xsl:with-param name="node" select="local-name()"/>
  ...
  <xsl:if test="@name='info'">
    <xsl:call-template name="output-info">
      <xsl:with-param name="infoString">
        <xsl:text>&lt;meta name='info' content='</xsl:text>
        <xsl:value-of select="@content"/>
          <xsl:text>'/&gt;</xsl:text>
      </xsl:with-param>
      <xsl:with-param name="node" select="local-name()"/>
  ...
  <xsl:if test="@name='author'">
    <xsl:call-template name="output-hint">
      <xsl:with-param name="hintString">
        ...
        <xsl:text>&lt;meta name='author' content='</xsl:text>
        <xsl:value-of select="@content"/>
          <xsl:text>'/&gt;</xsl:text>
      </xsl:with-param>
      <xsl:with-param name="node" select="local-name()"/>
  ...
  <xsl:if test="@name='copyright'">
    <xsl:call-template name="output-hint">
      <xsl:with-param name="hintString">
        ...
        <xsl:text>&lt;meta name='copyright' content='</xsl:text>
        <xsl:value-of select="@content"/>
          <xsl:text>'/&gt;</xsl:text>
      </xsl:with-param>
      <xsl:with-param name="node" select="local-name()"/>
  ...
  <xsl:if test="@name='keywords'">
    <xsl:call-template name="output-hint">
      <xsl:with-param name="hintString">
        ...
        <xsl:text>&lt;meta name='keywords' content='</xsl:text>
        <xsl:value-of select="@content"/>
          <xsl:text>'/&gt;</xsl:text>
      </xsl:with-param>
      <xsl:with-param name="node" select="local-name()"/>
  ...
  <xsl:if test="@name='movie'">
    <xsl:call-template name="output-hint">
      <xsl:with-param name="hintString">
        ...
        <xsl:text>&lt;meta name='movie' content='</xsl:text>
        <xsl:value-of select="@content"/>
          <xsl:text>'/&gt;</xsl:text>
      </xsl:with-param>
      <xsl:with-param name="node" select="local-name()"/>
  ...
  <xsl:if test="@name='filename'">
    <xsl:call-template name="output-hint">
      <xsl:with-param name="hintString">
        ...
        <xsl:text>&lt;meta name='filename' content='</xsl:text>
        <xsl:value-of select="@content"/>
          <xsl:text>'/&gt;</xsl:text>
      </xsl:with-param>
      <xsl:with-param name="node" select="local-name()"/>
  ...
  <xsl:if test="@name='revised'">
    <xsl:call-template name="output-hint">
      <xsl:with-param name="hintString">
        ...
        <xsl:text>&lt;meta name='revised' content='</xsl:text>
        <xsl:value-of select="@content"/>
          <xsl:text>'/&gt;</xsl:text>
      </xsl:with-param>
      <xsl:with-param name="node" select="local-name()"/>
  ...
  <xsl:if test="@name='url'">
    <xsl:call-template name="output-hint">
      <xsl:with-param name="hintString">
        ...
        <xsl:text>&lt;meta name='url' content='</xsl:text>
        <xsl:value-of select="@content"/>
          <xsl:text>'/&gt;</xsl:text>
      </xsl:with-param>
      <xsl:with-param name="node" select="local-name()"/>
...
<!--        <xsl:when test="@nodeField and (preceding::ExternProtoDeclare[@name=$protoName]/field[@name=$nodeField])"> -->
      ...
      <xsl:when test="starts-with(local-name(),'Metadata')">
          ...
          <xsl:when test="(local-name()='MetadataSet') and (count(*[(@containerField='metadata' or @containerField='')]) > 1)">
            <xsl:call-template name="output-warning">
              <xsl:with-param name="warningString">
                <xsl:text>MetadataSet has more than one contained-child Metadata nodes with default @containerField='metadata'.  Reset appropriate child nodes that are part of the set to have @containerField='value'</xsl:text>
              </xsl:with-param>
              <xsl:with-param name="node" select="local-name()"/>
              <xsl:with-param name="DEF"  select="@DEF"/>
            </xsl:call-template>
 ...
 or local-name(..)='GeoLocation' or local-name(..)='GeoLOD' or local-name(..)='HAnimJoint' or local-name(..)='HAnimSegment' or local-name(..)='HAnimSite' or local-name(..)='Contour2D'">
         ...
         <xsl:when test="starts-with(local-name(..),'Metadata')">
          ...
          <xsl:when test="local-name(..)='Appearance' or local-name(..)='Shape' or contains(local-name(..),'Sound') or local-name(..)='Text' or local-name(..)='MultiTexture' or local-name(..)='MultiTextureCoordinate' or local-name(..)='MultiTextureTransform'
              ...
              <xsl:with-param name="errorString">
                ...
                <xsl:choose>
                  ...
                  <xsl:when test="local-name(..)='NurbsOrientationInterpolator' or local-name(..)='NurbsPositionInterpolator' or local-name(..)='NurbsSurfaceInterpolator'">
                    <xsl:text>controlPoints, metadata</xsl:text>
                  </xsl:when>
                  <xsl:when test="local-name(..)='NurbsPatchSurface'">
                    <xsl:text>controlPoints, metadata, texCoord</xsl:text>
                  </xsl:when>
  ...
  <xsl:if test="* or comment()">
    ...
    <xsl:choose>
      ...
      <xsl:when test="(local-name()='CADFace'       or $nodeType='CADFace'       or $EPnodeType='CADFace'       or @nodeType='CADFace')
                      and (*)">
        <xsl:if test="*[(local-name() != 'LOD') and (local-name() != 'Shape')]">
          <!-- no ROUTE children allowed -->
          <xsl:call-template name="output-error">
            <xsl:with-param name="errorString">
              <xsl:text>CADFace has illegal child </xsl:text>
              <xsl:value-of select="local-name(*[1])"/>
              <xsl:text>, only a single LOD or Shape node is allowed</xsl:text>
            </xsl:with-param>
            <xsl:with-param name="node">
              <xsl:text> node</xsl:text>
              <xsl:value-of select="local-name(.)"/>
      ...
      <xsl:when test="(local-name()='LoadSensor'       or $nodeType='LoadSensor'       or $EPnodeType='LoadSensor'       or @nodeType='LoadSensor')
                      and (* or fieldValue[@name='watchList']/*)">
        <xsl:choose>
          <!-- no ROUTE children allowed -->
      ...
      <xsl:when test="(local-name()='LOD'       or $nodeType='LOD'       or $EPnodeType='LOD'       or @nodeType='LOD')
                      and (level/* or *[local-name()!='fieldValue' and local-name()!='ROUTE' and local-name()!='IS'])">
        <xsl:choose>
          <xsl:when test="level/*">
      ...
      <xsl:when test="local-name()='HAnimHumanoid' ">
        ...
        <xsl:for-each select="HAnimSite[not(@containerField='sites' or @containerField='children')]">
          <xsl:call-template name="output-error">
            <xsl:with-param name="errorString">
              <xsl:text>HAnimSite has illegal containerField='</xsl:text>
              <xsl:value-of select="@containerField"/>
              <xsl:text>' (allowed value: sites)</xsl:text>
            </xsl:with-param>
            <xsl:with-param name="node">
              <xsl:text> node</xsl:text>
              <xsl:value-of select="local-name(.)"/>
    ...
    <xsl:if test="not(@USE) and
              ((((local-name()='Anchor'        or $nodeType='Anchor'         or $EPnodeType='Anchor'         or @nodeType='Anchor'      or
                 ...
                 and (children/* or *[local-name()!='fieldValue' and local-name()!='GeoOrigin' and local-name()!='ROUTE' and local-name()!='IS'])
               ...
               ((local-name()='Switch'    or $nodeType='Switch'    or $EPnodeType='Switch'    or @nodeType='Switch')
                 and (choice/* or *[local-name()!='fieldValue' and local-name()!='ROUTE' and local-name()!='IS']))
                 or
...
-->
    ...
    <xsl:choose>
      ...
      <xsl:when test="(@url and not(starts-with(normalize-space(@url),'ecmascript:'))) or (normalize-space(.) and not(starts-with(normalize-space(.),'ecmascript:')))">
        <xsl:call-template name="output-error">
          <xsl:with-param name="errorString">
    ...
    <xsl:if test="@url and (starts-with(normalize-space(.),'ecmascript:') or starts-with(normalize-space(.),'javascript:')
    			    or normalize-space(.))">
        <xsl:call-template name="output-warning">
          <xsl:with-param name="warningString">
  ...
  <xsl:if test="(local-name()='Anchor' or local-name()='AudioClip' or local-name()='CylinderSensor' or local-name()='PlaneSensor' or local-name()='SphereSensor' or local-name()='TouchSensor' or local-name()='Viewpoint') and (not(@description) or normalize-space(@description)='') and not(@USE) and not(IS/connect/@nodeField='description')">
    <xsl:call-template name="output-hint">
      <xsl:with-param name="hintString">
        ...
        <xsl:choose>
          <xsl:when test="local-name()='Anchor' and contains(@url,'#')">
            <xsl:text>click to change viewpoints</xsl:text>
          </xsl:when>
          <xsl:when test="local-name()='Anchor' and contains(@parameter,'target=')">
            <xsl:text>click to load a separate window</xsl:text>
          </xsl:when>
          <xsl:when test="local-name()='Anchor'">
            <xsl:text>click to load a separate scene</xsl:text>
          </xsl:when>
  ...
  <xsl:if test="not(local-name()='Viewpoint' and (ancestor::*[(local-name()='ProtoInstance' and @name='ViewpointGroup') or local-name()='ViewpointGroup']))">
    ...
    <xsl:if test="(local-name()='Viewpoint' or local-name()='Background' or local-name()='Fog' or local-name()='NavigationInfo') and (ancestor::*[local-name()='LOD'])">
      <xsl:call-template name="output-warning">
        <xsl:with-param name="warningString">
          <xsl:value-of select="local-name()" />
    ...
    <xsl:if test="(local-name()='Viewpoint' or local-name()='Background' or local-name()='Fog' or local-name()='NavigationInfo') and (ancestor::*[local-name()='Switch'])">
      <xsl:call-template name="output-warning">
        <xsl:with-param name="warningString">
          <xsl:value-of select="local-name()" />
  ...
  <xsl:if test="contains(local-name(),'Filter') or contains(local-name(),'Interpolator') or contains(local-name(),'Sequencer') or contains(local-name(),'Toggle') or contains(local-name(),'Trigger')">
    <xsl:if test="not(//ROUTE[@toNode=$DEF]) and not((local-name(..)='field') or (local-name(..)='fieldValue')) and not(IS) and not(@USE)">
      <xsl:call-template name="output-warning">
        <xsl:with-param name="warningString">
          <xsl:text>no ROUTE found for input to </xsl:text>
          <xsl:value-of select="local-name()" />
        </xsl:with-param>
        <xsl:with-param name="node">
          <xsl:value-of select="local-name()" />
  ...
  <xsl:if test="contains(local-name(),'Filter') or contains(local-name(),'Interpolator') or contains(local-name(),'Sensor') or contains(local-name(),'Sequencer') or contains(local-name(),'Toggle') or contains(local-name(),'Trigger')">
    <xsl:if test="not(//ROUTE[@fromNode=$DEF]) and not((local-name(..)='field') or (local-name(..)='fieldValue')) and not(IS) and not(@USE)">
      <xsl:call-template name="output-warning">
        <xsl:with-param name="warningString">
          <xsl:text>no ROUTE found for output of </xsl:text>
          <xsl:value-of select="local-name()" />
        </xsl:with-param>
        <xsl:with-param name="node">
          <xsl:value-of select="local-name()" />
  ...
  <!-- Background node not affected by Transform -->
  <xsl:variable name="BackgroundParentTransform" select="ancestor::*[local-name()='Transform']"/>
  <xsl:if test="(local-name()='Background')">
    <xsl:if test="$BackgroundParentTransform[(@translation and @translation!='' and @translation!='1 1 1') or (@scale and @scale!='' and @scale!='1 1 1')]">
      <xsl:call-template name="output-warning">
        <xsl:with-param name="warningString">
          <xsl:value-of select="local-name()" />
          <xsl:text> node not affected by translation or scaling of parent &lt;Transform</xsl:text>
          <xsl:if test="$BackgroundParentTransform/@DEF">
            <xsl:text> DEF='</xsl:text>
            <xsl:value-of select="$BackgroundParentTransform/@DEF" />
            <xsl:text>'</xsl:text>
          </xsl:if>
          <xsl:if test="$BackgroundParentTransform/@translation">
            <xsl:text> translation='</xsl:text>
            <xsl:value-of select="$BackgroundParentTransform/@translation" />
            <xsl:text>'</xsl:text>
          </xsl:if>
          <xsl:if test="$BackgroundParentTransform/@scale">
            <xsl:text> scale='</xsl:text>
            <xsl:value-of select="$BackgroundParentTransform/@scale" />
            <xsl:text>' </xsl:text>
          </xsl:if>
          <xsl:text>/&gt;</xsl:text>
       </xsl:with-param>
  ...
  <xsl:if test="(starts-with(local-name(),'Metadata') and not(@containerField='metadata' or @containerField='value' or @containerField='' or not(@containerField)))">
    <xsl:call-template name="output-error">
      <xsl:with-param name="errorString">
        ...
        <xsl:text> containerField='</xsl:text>
        <xsl:value-of select="@containerField" />
        <xsl:text>' is illegal, use 'metadata'</xsl:text>
  ...
  <xsl:variable name="containerFieldTest2"
  	select="((local-name(..)='IndexedFaceSet' or local-name(..)='IndexedTriangleFanSet' or local-name(..)='IndexedTriangleSet'or local-name(..)='IndexedTriangleStripSet' 
  	        ...
  	        ((local-name(..)='NurbsOrientationInterpolator' or local-name(..)='NurbsPositionInterpolator') and not(@containerField='controlPoints' or @containerField='' or not(@containerField))) or
  	        ...
  	        ((local-name(..)='NurbsSurfaceInterpolator') and not(@containerField='controlPoints' or @containerField='' or not(@containerField))) or
...
<!--<xsl:variable name="DEF" select="normalize-space(@DEF)" />-->
    ...
    <xsl:if test="preceding::*[normalize-space(@url)=$url] | following::*[normalize-space(@url)=$url]">
      <xsl:variable name="otherParentProtoName">
        <xsl:choose>
          ...
          <xsl:when test="preceding::*[normalize-space(@url)=$url]">
            <xsl:value-of select="preceding::*[normalize-space(@url)=$url]/@name" />
          </xsl:when>
          <xsl:when test="following::*[normalize-space(@url)=$url]">
            <xsl:value-of select="following::*[normalize-space(@url)=$url]/@name" />
          </xsl:when>
        </xsl:choose>
      </xsl:variable>
  ...
  <xsl:if test="normalize-space(@url) or
  	(normalize-space(@frontUrl)  and not(contains(@frontUrl,'http://'))) or
  	(normalize-space(@backUrl)   and not(contains(@backUrl,'http://'))) or
  	(normalize-space(@topUrl)    and not(contains(@topUrl,'http://'))) or
  	(normalize-space(@bottomUrl) and not(contains(@bottomUrl,'http://'))) or
  	(normalize-space(@leftUrl)   and not(contains(@leftUrl,'http://'))) or
  	(normalize-space(@rightUrl)  and not(contains(@rightUrl,'http://')))">
...
<!--    		  not(local-name(..)='Background') and -->
      ...
      <xsl:call-template name="output-hint">
        <xsl:with-param name="hintString">
          <xsl:text>For maximum scene portability, append alternate online address for revised url=' </xsl:text>
          <xsl:text>"</xsl:text>
...
<xsl:template match="@*">
  ...
  <!-- this block is used identically in X3dToVrml97.xslt X3dToHtml.xslt X3dUnwrap.xslt and X3dWrap.xslt -->
  ...
  <xsl:variable name="notDefaultFieldValue7"
	select="not( local-name(..)='SphereSensor' and
		...
		not( parent::SpotLight	and
						((local-name()='ambientIntensity' and (.='0' or .='0.0')) or
						 (local-name()='attenuation' and (.='1 0 0' or .='1.0 0.0 0.0')) or
						 (local-name()='beamWidth' and .='1.570796') or
						 (local-name()='color' and (.='1 1 1' or .='1.0 1.0 1.0')) or
						 (local-name()='cutOffAngle' and (.='.785398' or .='0.785398')) or
						 (local-name()='direction' and (.='0 0 -1' or .='0.0 0.0 -1.0')) or
						 (local-name()='global' and (.='true')) or
						 (local-name()='intensity' and (.='1' or .='1.0')) or
						 (local-name()='location' and (.='0 0 0' or .='0.0 0.0 0.0')) or
		...
		not( local-name(..)='Text'   and ((local-name()='maxExtent' and (.='0' or .='0.0')) or
						  (local-name()='solid' and .='true'))) and
  ...
  <xsl:variable name="notDefaultNurbs"
	select="not((local-name(..)='NurbsCurve' or local-name(..)='NurbsCurve2D') and
		...
		not(local-name(..)='NurbsOrientationInterpolator' and
						((local-name()='order' and (.='3' or .='3.0')))) and
		not(local-name(..)='NurbsPositionInterpolator' and
						((local-name()='order' and (.='3' or .='3.0')))) and
		not((local-name(..)='NurbsPatchSurface' or local-name(..)='NurbsTextureSurface') and
		...
		not(local-name(..)='NurbsSet' and
						((local-name()='tessellationScale' and (.='1' or .='1.0'))))" />
  ...
  <xsl:if test="$notDefaultValue">
    ...
    <xsl:if test="(../@USE and not(local-name()='USE')) and not(local-name(..)='NavigationInfo' and ../@type='&quot;EXAMINE&quot; &quot;ANY&quot;')">
    ...
    <xsl:choose>
      ...
      <xsl:when test="(local-name()='solid') and ($fileEncoding='VRML97') and (.='false') and ((local-name(..)='Box') or (local-name(..)='Cone') or (local-name(..)='Cylinder') or (local-name(..)='Sphere') or (local-name(..)='Text') or (local-name(..)='ArcClose2D') or (local-name(..)='Circle2D') or (local-name(..)='Disk2D') or (local-name(..)='Rectangle2D') or (local-name(..)='TriangleSet2D'))">
        <xsl:call-template name="output-warning">
          <xsl:with-param name="warningString">
            <xsl:text>&lt;</xsl:text>
            <xsl:value-of select="local-name(..)"/>
            <xsl:text> solid="false" /&gt; not supported in VRML97 encoding, solid field ignored</xsl:text>
          </xsl:with-param>
          <xsl:with-param name="node">
            <xsl:value-of select="local-name(..)"/>
            <xsl:text> attribute </xsl:text>
        ...
        <xsl:choose>
          <xsl:when test="(local-name()='forceTransitions')">
            <xsl:if test="(//X3D/@version='3.0') or ($fileEncoding='VRML97')">
              <xsl:call-template name="output-warning">
                <xsl:with-param name="warningString">
                  <xsl:text>LOD forceTransitions only allowed for X3D 3.1 or greater</xsl:text>
                </xsl:with-param>
                <xsl:with-param name="node">
                  <xsl:value-of select="local-name(..)"/>
                  <xsl:text> attribute </xsl:text>
      ...
      <xsl:when test="	($parentElementName='Fog' and $attributeName='fogType') or
        ...
        <xsl:choose>
          ...
          <xsl:when test="($parentElementName='EspduTransform' and ($attributeName='networkMode'))">
            <xsl:if test="($normalizeSpaceValue!='local') and ($normalizeSpaceValue!='remote') and ($normalizeSpaceValue!='master')">
              <xsl:call-template name="output-warning">
                <xsl:with-param name="warningString">
                  <xsl:text>Enumeration attribute </xsl:text>
                  <xsl:value-of select="local-name()"/>
      ...
      <xsl:when test="	($attributeName='bboxCenter') or
        ...
        <xsl:choose>
          ...
          <xsl:when test="(($parentElementName='Box' and $attributeName='size') or
      	  	           ...
      	  	           ($parentElementName='Transform' and $attributeName='scale')) and
          	          ((contains($blankedValue,' -') or
            	            contains($blankedValue,' 0 ') or contains($blankedValue,' 0.0 ') or contains($blankedValue,' .0 ') or contains($blankedValue,' 0. ')))">
            <xsl:call-template name="output-error">
              <xsl:with-param name="errorString">
          ...
          <xsl:if test="(($tupleCount div 4)!=$spineCount) and (($tupleCount div 4)!=1) and not(($spine='' or $spine=' ') and ($tupleCount div 4)>=2)">
            <xsl:call-template name="output-error">
              <xsl:with-param name="errorString">
                ...
                <xsl:text> orientation 4-tuples)</xsl:text>
              </xsl:with-param>
              <xsl:with-param name="node">
                <xsl:value-of select="local-name(..)"/>
                <xsl:text> node</xsl:text>
...
<xsl:template match="@documentation[local-name(..)='field' or local-name(..)='ProtoDeclare' or local-name(..)='ExternProtoDeclare']">
  <xsl:if test="normalize-space(.)">
    ...
    <xsl:if test="not(contains(.,'://')) and not(contains(.,'.'))">
      <xsl:call-template name="output-warning">
        <xsl:with-param name="warningString">
          <xsl:text>documentation attribute usually contains url of reference document.</xsl:text>
        </xsl:with-param>
        <xsl:with-param name="node">
          <xsl:choose>
...
<xsl:choose>
  ...
  <xsl:when test="@value and *">
    ...
    <xsl:when test="* and ../IS/connect[@nodeField=$fieldName]">
      <xsl:call-template name="output-error">
        <xsl:with-param name="errorString">
  ...
  <xsl:when test="@value">
    ...
    <xsl:choose>
      ...
      <!-- output doubles -->
      <xsl:when test="(  $nodeType='SFVec2d' or   $nodeType='SFVec3d' or   $nodeType='MFVec2d' or   $nodeType='MFVec3d' or
...
<xsl:param name="indent"><xsl:text>0</xsl:text></xsl:param>
  ...
  <xsl:if test="local-name(..)='ProtoInterface' and not(../../ProtoBody//IS/connect[@protoField=$fieldName])">
    <xsl:call-template name="output-error">
      <xsl:with-param name="errorString">
        <xsl:text>ProtoInstance &lt;field name='</xsl:text>
          <xsl:value-of select="@name"/>
  ...
  <xsl:if test="(@accessType='initializeOnly' or @accessType='inputOutput') and not(@type='SFString' or @type='MFString' or @type='SFNode' or @type='MFNode') and not(@value) and not(comment()) and not(../IS/connect[@nodeField=$fieldName]) and not(local-name(..)='ExternProtoDeclare')">
    <xsl:call-template name="output-warning">
      <xsl:with-param name="warningString">
  ...
  <xsl:if test="(@accessType='initializeOnly' or @accessType='inputOutput') and (@type='SFNode' or @type='MFNode') and not(*) and not(comment()) and not(../IS/connect[@nodeField=$fieldName]) and not(local-name(..)='ExternProtoDeclare')">
    <xsl:call-template name="output-info">
      <xsl:with-param name="infoString">
        <xsl:text>Initializing child </xsl:text>
        <xsl:value-of select="@type"/>
  ...
  <xsl:choose>
    <xsl:when test="* and (not(@type='SFNode') and not(@type='MFNode'))">
      <xsl:call-template name="output-error">
        <xsl:with-param name="errorString">
    ...
    <xsl:when test="* and ((@accessType='inputOnly') or (@accessType='outputOnly'))">
      <xsl:call-template name="output-error">
        <xsl:with-param name="errorString">
  ...
  <xsl:choose>
    ...
    <xsl:when test="   (local-name(..)='Script' or local-name(../..)='Script') and @accessType='inputOutput' ">
      <xsl:call-template name="output-warning">
        <xsl:with-param name="warningString">
          <xsl:text>field '</xsl:text>
          <xsl:value-of select="@name" />
  ...
  <xsl:choose>
    ...
    <xsl:when test="@type='SFVec2d'	"><xsl:text>SFString	# SFVec2d&#10;</xsl:text></xsl:when>
    <xsl:when test="@type='MFVec2d'	"><xsl:text>SFString	# MFVec2d&#10;</xsl:text></xsl:when>
    <xsl:when test="@type='SFVec3d'	"><xsl:text>SFString	# SFVec3d&#10;</xsl:text></xsl:when>
    <xsl:when test="@type='MFVec3d'	"><xsl:text>SFString	# MFVec3d&#10;</xsl:text></xsl:when>
  ...
  <xsl:choose>
    ...
    <xsl:when test="* and local-name(..)='ExternProtoDeclare'">
         <xsl:call-template name="output-error">
           <xsl:with-param name="errorString">
    ...
    <xsl:when test="(@value) and (../IS/connect[@nodeField=$fieldName])">
      <xsl:call-template name="output-error">
        <xsl:with-param name="errorString">
          <xsl:text>IS-connected fields cannot be initialized, ignoring value="</xsl:text>
          <xsl:value-of select="@value" />
          <xsl:text>"</xsl:text>
        </xsl:with-param>
        <xsl:with-param name="node">
    ...
    <xsl:when test="* and ../IS/connect[@nodeField=$fieldName]">
      <xsl:call-template name="output-error">
        <xsl:with-param name="errorString">
          <xsl:text>IS-connected fields cannot be initialized, ignoring contained node</xsl:text>
        </xsl:with-param>
        <xsl:with-param name="node">
          <xsl:text>field '</xsl:text>
          <xsl:value-of select="@name" />
   ...
   <!-- <xsl:when test="@type='MFBool'"><xsl:text> [ </xsl:text><xsl:value-of select="translate(@value,'truefalse','TRUEFALSE')" /><xsl:text> ]</xsl:text></xsl:when> -->
        ...
        <xsl:when test="@value and (@type='SFVec2d' or @type='SFVec3d'   or @type='MFVec2d')"><xsl:text> "</xsl:text><xsl:value-of select="@value" /><xsl:text>"</xsl:text></xsl:when>
...
<xsl:choose>
  <xsl:when test="ProtoBody">
    <xsl:if test="count(ProtoBody/*[(local-name()!='Script') and (local-name()!='ROUTE') and (local-name()!='ProtoDeclare') and (local-name()!='ExternProtoDeclare') and not(comment())]) > 1">
      <!-- maybe try to improve filtering by testing for Shape or geometry here? -->
      <xsl:if test="ProtoBody/node()[position()=2][not(comment())]">
        <xsl:call-template name="output-warning">
          <xsl:with-param name="warningString">
            <xsl:text disable-output-escaping="yes"><![CDATA[<]]></xsl:text>
            ...
            <xsl:text>'/</xsl:text>
            <xsl:text disable-output-escaping="yes"><![CDATA[>]]></xsl:text>
            <xsl:text> ProtoBody child</xsl:text>
            <xsl:if test="ProtoBody/*[position() > 2]">
              <xsl:text>ren</xsl:text>
            </xsl:if>
            <xsl:text> following first child will not be rendered.</xsl:text>
          </xsl:with-param>
        </xsl:call-template>
      </xsl:if>
    </xsl:if>
      ...
      <xsl:if test="($tupleCount mod 2) != 0">
        <xsl:call-template name="output-error">
          <xsl:with-param name="errorString">
            ...
            <xsl:text>='</xsl:text><xsl:value-of select="substring(normalize-space($value),1,100)"/><xsl:text>'</xsl:text>
            <xsl:if test="string-length(normalize-space($value)) > 100"><xsl:text> [...]</xsl:text></xsl:if>
            <xsl:text> must contain an even multiple of paired values</xsl:text>
          </xsl:with-param>
          <xsl:with-param name="node">
            <xsl:value-of select="local-name(..)"/>
            <xsl:text> node</xsl:text>
      ...
      <xsl:if test="($tupleCount mod 3) != 0">
        <xsl:call-template name="output-error">
          <xsl:with-param name="errorString">
            ...
            <xsl:text>='</xsl:text><xsl:value-of select="substring(normalize-space($value),1,100)"/><xsl:text>'</xsl:text>
            <xsl:if test="string-length(normalize-space($value)) > 100"><xsl:text> [...]</xsl:text></xsl:if>
            <xsl:text> must contain an even multiple of triplet values</xsl:text>
          </xsl:with-param>
          <xsl:with-param name="node">
            <xsl:value-of select="local-name(..)"/>
            <xsl:text> node</xsl:text>
  ...
  <xsl:if test="(local-name()='meta') and ($sizeQuoteCount = 2) and (starts-with(normalize-space($inputString),'&quot;'))">
    <xsl:call-template name="output-hint">
      <xsl:with-param name="hintString">
        ...
        <xsl:value-of select="@name"/>
        <xsl:text>'&gt; content does not need to be quoted</xsl:text>
      </xsl:with-param>
      <xsl:with-param name="node">
        <xsl:value-of select="local-name()"/>
      </xsl:with-param>
...
<!--   <xsl:message> ###  inputString received: <xsl:value-of select="$inputString"/>&#10;</xsl:message>
  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      ...
      <xsl:value-of select="substring-before($inputString,'Browser.print')"/>
...
<xsl:template name="output-info">
  ...
  <xsl:message>
    ...
    <xsl:if test="local-name()!='meta' and ($node or $DEF)">
      <xsl:text> [</xsl:text>
      <xsl:choose>
        <xsl:when test="$DEF">
          <xsl:value-of select="$node"/>
...
<xsl:template name="check-profile">
  ...
  <xsl:choose>
    ...
    <xsl:when test="(/X3D/@profile = 'Full')">
      <xsl:call-template name="output-warning">
        <xsl:with-param name="warningString">
          <xsl:text>&lt;X3D profile='</xsl:text>
          <xsl:value-of select="/X3D/@profile"/>
          <xsl:text>'&gt; is not supported by all browsers.  Consider using Immersive or lower profile, adding component tag(s) if needed.</xsl:text>
        </xsl:with-param>
        <xsl:with-param name="node">
        ...
        <xsl:when test="not(/X3D/head/component)">
          <xsl:call-template name="output-error">
            <xsl:with-param name="errorString">
              <xsl:text>&lt;X3D profile='</xsl:text>
              <xsl:value-of select="/X3D/@profile"/>
              <xsl:text>'&gt; is not sufficient, since computed profile='</xsl:text>
    ...
    <xsl:when test="(/X3D/@profile='MPEG4Interactive') and
      ...
      <xsl:call-template name="output-error">
        <xsl:with-param name="errorString">
          <xsl:text>&lt;X3D profile='</xsl:text>
          <xsl:value-of select="/X3D/@profile"/>
          <xsl:text>'&gt; is insufficient due to contained nodes in a higher profile</xsl:text>
        </xsl:with-param>
        <xsl:with-param name="node">
          <xsl:text>root X3D</xsl:text>
        </xsl:with-param>
    ...
    <xsl:when test="(/X3D/@profile != $computedProfile)">
      <xsl:call-template name="output-info">
        <xsl:with-param name="infoString">
          <xsl:text>&lt;X3D profile='</xsl:text>
          <xsl:value-of select="/X3D/@profile"/>
          <xsl:text>'&gt; differs from computed profile='</xsl:text>
          <xsl:value-of select="$computedProfile"/>
          <xsl:text>'</xsl:text>
          <xsl:choose>
            <xsl:when test="//ProtoInstance and //Inline">
              <xsl:text> (though contained ProtoInstance and Inline nodes may need the higher profile)</xsl:text>
            </xsl:when>
            <xsl:when test="//ProtoInstance">
              <xsl:text> (though contained ProtoInstance nodes may need the higher profile)</xsl:text>
            </xsl:when>
            <xsl:when test="//Inline">
              <xsl:text> (though contained Inline nodes may need the higher profile)</xsl:text>
            </xsl:when>
          </xsl:choose>
        </xsl:with-param>
      </xsl:call-template>
...
<!-- debug
  <xsl:message>
    <xsl:text>&lt;X3D profile='</xsl:text>
    <xsl:value-of select="/X3D/@profile"/>
    <xsl:text>'&gt;, computed profile='</xsl:text>
    <xsl:value-of select="$computedProfile"/>
    <xsl:text>'</xsl:text>
  </xsl:message>
-->
...
<xsl:template name="check-components">
  <xsl:param name="computedProfile"/>
    ...
    <xsl:for-each select="//*">
	  ...
	  <!-- check if current node solely in Full profile -->
          <xsl:choose>
            ...
            <xsl:when test="local-name()='Image3DTexture'">					<xsl:text>Full.Texturing3D=2</xsl:text></xsl:when>
              ...
              <xsl:if test="not(/X3D/@profile='Immersive')">
                  ...
                  <xsl:otherwise>
                    <xsl:if test="not(/X3D/@profile='Interactive')">
                        ...
                        <xsl:when test="local-name()='Inline'">					<xsl:text>Interactive.Networking=3</xsl:text></xsl:when>
          ...
          <xsl:when test="/X3D/head/component[@name=$neededComponent]">
            <xsl:call-template name="output-hint">
              <xsl:with-param name="hintString">
                ...
                <xsl:text>'&gt; or else &lt;component name='</xsl:text>
