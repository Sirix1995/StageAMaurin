...
//	}
	 ...
	 * @return area 
	 */
	public static double getAreaOfNonTriangultion (float[] pointlist) {
		// check input data
		if(pointlist.length<9) {
			System.out.println("Error in getAreaOfNonTriangultion: Number of points must be at least three. I switched to the default leaf.");
			return 0;
		}
		if(pointlist.length%3!=0) {
			System.out.println("Error in getAreaOfNonTriangultion: Number of points must be a multiple of three. I switched to the default leaf.");
			return 0;
		}
	 ...
	 * @return area 
	 */
	public static double getAreaOfTriangultion (float[] pointlist) {
		// check input data
		if(pointlist.length<9) {
			System.out.println("Error in getAreaOfTriangultion: Number of points must be at least three. I switched to the default leaf.");
			return 0;
		}
		if(pointlist.length%3!=0) {
			System.out.println("Error in getAreaOfTriangultion: Number of points must be a multiple of three. I switched to the default leaf.");
			return 0;
		}
	 ...
	 * @return area 
	 */
	public static double getAreaOfNonTriangultion (Point3d[] pointlist) {
		return getAreaOfNonTriangultion(toArray(pointlist));
	}
	 ...
	 * @return area 
	 */
	public static double getAreaOfTriangultion (Point3d[] pointlist) {
		return getAreaOfTriangultion(toArray(pointlist));
	}
