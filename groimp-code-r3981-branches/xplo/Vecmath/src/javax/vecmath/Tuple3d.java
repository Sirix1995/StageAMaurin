...
/*
 * 2005/05/26: Addition of Cloneable-interface and clone()-method by Ole Kniemeyer
 * 
 * $Log: Tuple3d.java,v $
 ...
 */
	...
	public boolean equals(Object o1) {
    	return (o1 instanceof Tuple3d) && equals((Tuple3d)o1);
    }
	...
	public final void interpolate(Tuple3d t1, Tuple3d t2, float alpha) {
    	float beta = 1 - alpha;
    	x = beta*t1.x + alpha*t2.x;
    	y = beta*t1.y + alpha*t2.y;
    	z = beta*t1.z + alpha*t2.z;
    }
    ...
    public final void interpolate(Tuple3d t1, double alpha) {
	 ...
	 /**
      * Take the maximum of this tuple and tuple t1 and places the
      * result into this tuple.
      * @param t1 the first tuple
     */
	public final void max(Tuple3d t1) {
	   	x = Math.max( t1.x , x );
	 	y = Math.max( t1.y , y );
	 	z = Math.max( t1.z , z );
	}
	...
	/**
     * Take the minimum of this tuple and tuple t1 and places the
     * result into this tuple.
     * @param t1 the first tuple
    */
	public final void min(Tuple3d in) {
	  	x = Math.min( in.x , x );
	 	y = Math.min( in.y , y );
		z = Math.min( in.z , z );
	}

	// 05/26,'05: added by Ole Kniemeyer 
	@Override
