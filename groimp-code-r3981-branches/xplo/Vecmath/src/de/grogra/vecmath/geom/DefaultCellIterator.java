...
public class DefaultCellIterator implements CellIterator, Cloneable
{
	...
	private BoundingBox cellBounds = new BoundingBox (new Point3d (),
		new Point3d ());
	...
	public void initialize (Octree tree)
	{
		...
		coordToGrid = new Vector3d (1 / tree.minCellSize.x,
			1 / tree.minCellSize.y, 1 / tree.minCellSize.z);
	}
	...
	protected boolean hasNextImpl ()
	{
		...
		BoundingBox.computeIntersections (cellBounds, cellBounds.min,
			cellBounds.max, line, enteredFace < 0, list, enteredFace, -1);
	...
	public void setLine (Line line)
	{
		...
		else
		{
			...
			list.clear ();
			BoundingBox.computeIntersections (bounds, min, max, line, false,
				list, -1, -1);
			if (list.size == 0)
			{
				done = true;
