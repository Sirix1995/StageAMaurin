...
/**
 * Instances of <code>DoubleToIntGenerator</code> represent
 ...
 * <code>DoubleToIntGenerator f = double x => int*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface DoubleToIntGenerator
{
	/**
	 ...
	 */
	void evaluateInt (IntConsumer cons, double x);
}
