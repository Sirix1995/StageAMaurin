...
/**
 * Instances of <code>ByteToVoidGenerator</code> represent
 ...
 * <code>ByteToVoidGenerator f = byte x => void*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ByteToVoidGenerator
{
	/**
	 ...
	 */
	void evaluateVoid (VoidConsumer cons, byte x);
}
