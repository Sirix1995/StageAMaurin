...
/**
 * Instances of <code>BooleanToLongGenerator</code> represent
 ...
 * <code>BooleanToLongGenerator f = boolean x => long*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface BooleanToLongGenerator
{
	/**
	 ...
	 */
	void evaluateLong (LongConsumer cons, boolean x);
}
