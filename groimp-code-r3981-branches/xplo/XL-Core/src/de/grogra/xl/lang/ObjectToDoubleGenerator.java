...
/**
 * Instances of <code>ObjectToDoubleGenerator</code> represent
 ...
 * <code>ObjectToDoubleGenerator f = K x => double*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ObjectToDoubleGenerator<K>
{
	/**
	 ...
	 */
	void evaluateDouble (DoubleConsumer cons, K x);
}
