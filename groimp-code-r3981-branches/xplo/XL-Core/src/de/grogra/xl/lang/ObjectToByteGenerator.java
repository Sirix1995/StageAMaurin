...
/**
 * Instances of <code>ObjectToByteGenerator</code> represent
 ...
 * <code>ObjectToByteGenerator f = K x => byte*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ObjectToByteGenerator<K>
{
	/**
	 ...
	 */
	void evaluateByte (ByteConsumer cons, K x);
}
