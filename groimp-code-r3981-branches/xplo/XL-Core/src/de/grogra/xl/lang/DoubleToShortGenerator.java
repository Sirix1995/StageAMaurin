...
/**
 * Instances of <code>DoubleToShortGenerator</code> represent
 ...
 * <code>DoubleToShortGenerator f = double x => short*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface DoubleToShortGenerator
{
	/**
	 ...
	 */
	void evaluateShort (ShortConsumer cons, double x);
}
