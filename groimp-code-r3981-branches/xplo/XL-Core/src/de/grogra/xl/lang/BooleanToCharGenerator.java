...
/**
 * Instances of <code>BooleanToCharGenerator</code> represent
 ...
 * <code>BooleanToCharGenerator f = boolean x => char*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface BooleanToCharGenerator
{
	/**
	 ...
	 */
	void evaluateChar (CharConsumer cons, boolean x);
}
