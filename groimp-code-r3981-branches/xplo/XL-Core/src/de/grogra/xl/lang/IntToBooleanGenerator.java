...
/**
 * Instances of <code>IntToBooleanGenerator</code> represent
 ...
 * <code>IntToBooleanGenerator f = int x => boolean*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface IntToBooleanGenerator
{
	/**
	 ...
	 */
	void evaluateBoolean (BooleanConsumer cons, int x);
}
