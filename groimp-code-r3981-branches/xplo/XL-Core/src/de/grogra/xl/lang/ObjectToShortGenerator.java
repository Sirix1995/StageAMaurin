...
/**
 * Instances of <code>ObjectToShortGenerator</code> represent
 ...
 * <code>ObjectToShortGenerator f = K x => short*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ObjectToShortGenerator<K>
{
	/**
	 ...
	 */
	void evaluateShort (ShortConsumer cons, K x);
}
