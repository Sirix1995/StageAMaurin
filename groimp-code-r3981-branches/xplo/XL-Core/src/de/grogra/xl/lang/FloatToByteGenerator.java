...
/**
 * Instances of <code>FloatToByteGenerator</code> represent
 ...
 * <code>FloatToByteGenerator f = float x => byte*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface FloatToByteGenerator
{
	/**
	 ...
	 */
	void evaluateByte (ByteConsumer cons, float x);
}
