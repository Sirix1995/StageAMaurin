...
/**
 * Instances of <code>ByteToBoolean</code> represent functions
 * which take <code>byte</code>s as input and return values of
 * type <code>boolean</code>. Such instances are created by
 * lambda expressions of the XL programming language, e.g.,
 * <code>ByteToBoolean f = byte x => boolean</code>
 * <i>some expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ByteToBoolean
{
	/**
	 ...
	 */
	boolean evaluateBoolean (byte x);
}
