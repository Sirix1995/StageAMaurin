...
/**
 * Instances of <code>ObjectToVoidGenerator</code> represent
 ...
 * <code>ObjectToVoidGenerator f = K x => void*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ObjectToVoidGenerator<K>
{
	/**
	 ...
	 */
	void evaluateVoid (VoidConsumer cons, K x);
}
