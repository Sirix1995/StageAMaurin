...
/**
 * Instances of <code>DoubleToObject</code> represent functions
 ...
 * <code>DoubleToObject f = double x => V</code>
 * <i>some expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface DoubleToObject<V>
{
	/**
