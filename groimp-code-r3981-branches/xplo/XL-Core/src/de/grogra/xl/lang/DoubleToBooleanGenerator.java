...
/**
 * Instances of <code>DoubleToBooleanGenerator</code> represent
 ...
 * <code>DoubleToBooleanGenerator f = double x => boolean*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface DoubleToBooleanGenerator
{
	/**
	 ...
	 */
	void evaluateBoolean (BooleanConsumer cons, double x);
}
