...
/**
 * Instances of <code>IntToDoubleGenerator</code> represent
 ...
 * <code>IntToDoubleGenerator f = int x => double*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface IntToDoubleGenerator
{
	/**
	 ...
	 */
	void evaluateDouble (DoubleConsumer cons, int x);
}
