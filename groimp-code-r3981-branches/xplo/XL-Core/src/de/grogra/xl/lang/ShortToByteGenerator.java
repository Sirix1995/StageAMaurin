...
/**
 * Instances of <code>ShortToByteGenerator</code> represent
 ...
 * <code>ShortToByteGenerator f = short x => byte*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ShortToByteGenerator
{
	/**
	 ...
	 */
	void evaluateByte (ByteConsumer cons, short x);
}
