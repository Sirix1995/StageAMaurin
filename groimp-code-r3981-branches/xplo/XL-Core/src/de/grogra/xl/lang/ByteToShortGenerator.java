...
/**
 * Instances of <code>ByteToShortGenerator</code> represent
 ...
 * <code>ByteToShortGenerator f = byte x => short*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ByteToShortGenerator
{
	/**
	 ...
	 */
	void evaluateShort (ShortConsumer cons, byte x);
}
