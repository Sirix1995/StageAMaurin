...
/**
 * Instances of <code>DoubleToObjectGenerator</code> represent
 ...
 * <code>DoubleToObjectGenerator f = double x => V*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface DoubleToObjectGenerator<V>
{
	/**
	 ...
	 */
	void evaluateObject (ObjectConsumer<? super V> cons, double x);
}
