...
/**
 * Instances of <code>FloatToObjectGenerator</code> represent
 ...
 * <code>FloatToObjectGenerator f = float x => V*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface FloatToObjectGenerator<V>
{
	/**
	 ...
	 */
	void evaluateObject (ObjectConsumer<? super V> cons, float x);
}
