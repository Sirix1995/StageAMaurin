...
/**
 * Instances of <code>ShortToIntGenerator</code> represent
 ...
 * <code>ShortToIntGenerator f = short x => int*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ShortToIntGenerator
{
	/**
	 ...
	 */
	void evaluateInt (IntConsumer cons, short x);
}
