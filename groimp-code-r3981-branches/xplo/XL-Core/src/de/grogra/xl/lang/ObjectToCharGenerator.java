...
/**
 * Instances of <code>ObjectToCharGenerator</code> represent
 ...
 * <code>ObjectToCharGenerator f = K x => char*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface ObjectToCharGenerator<K>
{
	/**
	 ...
	 */
	void evaluateChar (CharConsumer cons, K x);
}
