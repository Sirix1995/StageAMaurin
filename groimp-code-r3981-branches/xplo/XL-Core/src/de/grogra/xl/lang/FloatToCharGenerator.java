...
/**
 * Instances of <code>FloatToCharGenerator</code> represent
 ...
 * <code>FloatToCharGenerator f = float x => char*</code>
 * <i>some generator expression containing x</i><code>;</code>.
 *
 * @author Ole Kniemeyer
 */
public interface FloatToCharGenerator
{
	/**
	 ...
	 */
	void evaluateChar (CharConsumer cons, float x);
}
