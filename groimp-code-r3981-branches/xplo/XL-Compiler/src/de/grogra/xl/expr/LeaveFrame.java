...
public final class LeaveFrame extends VoidExpression implements LocalAccess
{ 
	private Local vmx;
	private VMXState.Local local;
	

	public LeaveFrame (Local vmx)
	{
		this.vmx = vmx;
	}
	...
	{
		writer.visitLoad (local, vmx.getType ());
		writer.visitaconst (null);//AUTH
		writer.visitMethodInsn (vmx.getType (), "leave");
	}
