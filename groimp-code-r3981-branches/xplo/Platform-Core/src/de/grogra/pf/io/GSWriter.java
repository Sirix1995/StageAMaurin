...
public class GSWriter extends FilterBase implements FileWriterSource
{
	...
	public static void write (Registry reg, FileSystem fs, String projectFile)
		throws IOException
	{
		...
		DOMSource ds = new StreamAdapter (reg.createXMLSource (plugins), dom);
