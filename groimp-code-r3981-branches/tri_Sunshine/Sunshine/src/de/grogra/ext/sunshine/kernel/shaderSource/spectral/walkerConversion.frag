...
//int lamdaMin			// D65: 300	// RGB: 390	// XYZ: 360
//int lamdaMax
//int lamdaSteps
...
vec3 getXYZMatch(int lamda)
{
	...
	int pos 		= int((lamda - minLMatch) / float(lamdaSteps));
...
vec3 convert2RGB(vec3 xyz)
{
	...
	// Multiply the CIE XYZ color match function with intesity of the ray
	// for a certain wavelength (Lamda)
	//xyz 			= intensity * getXYZMatch(lamda);
