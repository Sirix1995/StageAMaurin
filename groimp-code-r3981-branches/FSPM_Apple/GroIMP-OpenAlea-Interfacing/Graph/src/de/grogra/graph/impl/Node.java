			...
			if (userFields == null)
			{
				...
				for (int i = 0; i < getManagedFieldCount (); i++)
				{
					...
					if ((f != null) && Reflection.isPublic (f)
						&& ((editable = Reflection.getDeclaredAnnotation (f, Editable.class)) != null)
						&& ((Boolean) editable.value("value")).booleanValue())
					{
...
//!! *# End of generated code
	...
	public void dupnew (Node original, boolean cloneFields, Transaction t)
			throws CloneNotSupportedException
		{
			NType type = original.getNType ();;
			for (int i = type.getManagedFieldCount () - 1; i >= 0; i--)
			{
				ManageableType.Field f = type.getManagedField (i);
				switch (f.getType ().getTypeId ())
...
//!! *# End of generated code
	...
	public String toString ()
	{
		return (getNType() == null) ? super.toString()
			: getNType ().getName () + '[' + paramString () + "]@" + Integer.toHexString (System.identityHashCode (this));
	}
	...
	public boolean isEncoarseOf (Node n)
	{
		for (Edge e = n.getFirstEdge (); e != null; e = e.getNext (n))
		{
			if ((e.getSource ()) != n) //not a self-loop
			{
				int b = e.getEdgeBits ();
				if ((b & Graph.REFINEMENT_EDGE) != 0) //is a refinement edge
				{
					if((e.getSource ()) == this)
					{
						return true;
					...
					{
						return this.isEncoarseOf((e.getSource ()));
					}
				}
			}
		}
	...
	public Node findRefinementType (Node n)
	{
		...
		{
			Node t = e.getTarget();
			if (t != this) //not a self-loop
			{
				int b = e.getEdgeBits ();
				if ((b & Graph.REFINEMENT_EDGE) != 0) //is a refinement edge
				{
					if(Reflection.equal(t.getNType(),n.getNType()))
					{
						return t;
					}
					else
					{
						Node nDeep = t.findRefinementType(n);
						if(nDeep!=null)
							return nDeep;
					}
				}
