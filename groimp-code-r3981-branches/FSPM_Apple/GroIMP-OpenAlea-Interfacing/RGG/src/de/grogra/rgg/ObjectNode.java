...
public class ObjectNode extends de.grogra.graph.impl.Node
{
	Object value;
	//enh:field setter
...
// NOTE: The following lines up to enh:end were generated automatically
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (ObjectNode.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
		...
		protected void setObjectImpl (Object o, Object value)
		{
			...
			{
				case 0:
					((ObjectNode) o).value = (Object) value;
					return;
			}
