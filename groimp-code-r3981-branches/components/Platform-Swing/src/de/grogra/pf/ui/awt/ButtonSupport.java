	...
	ActionListener, ItemListener, MouseMotionListener, Runnable, Disposable
{
	...
	public void mousePressed (MouseEvent e)
	{
		...
		if (state != DRAGGING)
		{
			...
			onClick (ClickEvent.MOUSE_CLICKED, e, dragOrigin, e.getComponent (), e.getSource());
		}
	}
	...
	private void onClick (int state, MouseEvent me, Point point, Component component, Object object)
	{
		UI.getJobManager (tree.getContext ()).runLater
			(new Dispatcher (new ClickEvent().set(tree.getContext (), object) ),
