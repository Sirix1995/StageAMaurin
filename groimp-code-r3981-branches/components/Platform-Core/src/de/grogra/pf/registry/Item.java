...
public class Item extends Node implements Described, RegistryContext
{
	...
	private static final int ST_COMPONENT = 4;
...
//!! *# End of generated code
		...
		throws ClassNotFoundException
	{
		return Class.forName
			(name, initialize, pluginDescriptor.getClassLoader ());
	}
...
*/
	...
	public Item initComponentDescriptor (ComponentDescriptor component)
	{
	 	if (this.componentDescriptor == null)
	 	{
	 		this.sourceType = ST_COMPONENT;
