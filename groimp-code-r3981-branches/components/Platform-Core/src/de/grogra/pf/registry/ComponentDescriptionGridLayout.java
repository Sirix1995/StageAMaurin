...
public class ComponentDescriptionGridLayout extends GridLayout 
{
	public ComponentDescriptionGridLayout() {
		this(1, 0, 0, 0);
	}

	public ComponentDescriptionGridLayout(int rows, int cols) {
		this(rows, cols, 0, 0);
	}

	public ComponentDescriptionGridLayout(int rows, int cols, int hgap, int vgap) {
