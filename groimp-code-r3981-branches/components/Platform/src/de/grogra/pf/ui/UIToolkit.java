...
*/
	...
	public abstract Widget createTextAreaWidget (Map params);
...
*/
	...
	/**
	 * Creates the tabs inside the "About GroIMP" panel.
	 * Therefore it uses the list "aboutapp.tabs" in IMP/src/plugin.properties to 
	 * identify the single tabs.
	 * 
	 * @param plugin
	 * @param prefix
	 * @param tabComponents
