 ...
 * @version 1.0
 */
public class StereoImage extends ImageTool{
	
	public static final int STEREO_COLUMN_INTERLEAVE_COLOR	=  5;
	public static final int STEREO_ROW_INTERLEAVE_COLOR		= -5;
	public static final int STEREO_SIDE_BY_SIDE_COLOR		=  6;
	public static final int STEREO_UP_DOWN_COLOR			= -6;
	
	public static final int[] STEREO_LIST = {STEREO_COLUMN_INTERLEAVE_COLOR, STEREO_ROW_INTERLEAVE_COLOR,
		STEREO_SIDE_BY_SIDE_COLOR, STEREO_UP_DOWN_COLOR};
	...
	/**
	 * Methode setzt rechte Bild
	 * @param right
	 */
	public void setRightImage(BufferedImage right) {
		this.setTransferX(0);
		this.setTransferY(0);
		this.right = right;
