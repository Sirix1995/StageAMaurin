...
public class Navigator3DFactory extends NavigatorFactory
{
	//enh:sco SCOType
	...
	public de.grogra.util.DisposableEventListener createNavigator
		(ViewEventHandlerIF h, EventObject e)
	{
		return new Navigator3D (h, e);
	}
...
// NOTE: The following lines up to enh:end were generated automatically
	...
	public static class Type extends SCOType
	{
		...
		public Type (Navigator3DFactory representative, de.grogra.persistence.SCOType supertype)
		{
	...
	static
	{
		$TYPE = new Type (Navigator3DFactory.class);
		$TYPE.validate ();
	}
