// $ANTLR 2.7.7 (2006-11-01): "vocabulary.g" -> "VocabularyLexer.java"$
...
public class VocabularyLexer extends antlr.CharScanner implements TokenizerBuilderTokenTypes, TokenStream
 {
public VocabularyLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public VocabularyLexer(Reader in) {
	this(new CharBuffer(in));
}
public VocabularyLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public VocabularyLexer(LexerSharedInputState state) {
	super(state);
