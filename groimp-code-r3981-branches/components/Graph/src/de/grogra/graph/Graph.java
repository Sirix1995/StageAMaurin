...
public interface Graph extends Lockable
{
	...
	/**
	 * The bit mask indicating the presence of a send edge in edge bits.
	 * This means that the target node of the edge is addressee of a data stream.
	 * This edge is only used in component graphs.
	 * 
	 *  2^18, Symbol: s 
	 * 
	 * @see Graph
	 * @see #getEdgeBits(Object)
	 */
	int SEND_EDGE = 0x40000;


	/**
	 * The bit mask indicating the presence of an uses edge in edge bits.
	 * This edge is only used in component graphs.
	 * 
	 * 2^19, Symbol: ~ 
	 *  
	 ...
	 * @see #getEdgeBits(Object)
	 */
	int USES_EDGE = 0x80000;


	/**
	 * The bit mask indicating the presence of a slot edge in edge bits.
	 * This edge is only used in component graphs.
	 * 
	 * 2^20, Symbol: $ 
	 * 
	 ...
	 * @see #getEdgeBits(Object)
	 */
	int SLOT_EDGE = 0x100000; 

	/**
	 * The bit mask indicating the presence of a dummy edge in edge bits.
	 * This edge is only used in component graphs to get "invisible" edges.
	 * If a component is not connected to an other component but it is still part of the graph, then
	 * normally it will be not drawn. To draw it it needs to be connected,
	 * with at least on other node of the graph, normally the root node.
	 *
	 * 10, Symbol: D
	 *
	 * @see Graph
	 * @see #getEdgeBits(Object)
	 */
	int DUMMY_EDGE = 0xc; //2^21 = 0x200000; 

	/**
	 * The bit mask indicating the presence of a component to slot edge in edge bits.
	 * This edge is only used in component graphs to get "invisible" edges from a component to a input slot. 
	 * 
	 * 10, Symbol: none
	 * 
	 * @see Graph
	 * @see #getEdgeBits(Object)
	 */
	int COMPONENT_INPUT_SLOT_EDGE = 0xa; 
	 ...
	 * @see #getEdgeBits(Object)
	 */
	int COMPONENT_OUTPUT_SLOT_EDGE = 0xb; 
	...
	/**
	 * The predefined root key which identifies the component graph.
	 * 
	 * @see Graph 
	 */	
	String COMPONENT_GRAPH = "ComponentGraph";
	 ...
	 * occurred can be simply performed on values of the stamp.
	 * 
	...
	void accept (Object startNode, Visitor visitor, ArrayPath placeInPath, String graphType);
