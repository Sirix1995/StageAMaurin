...
public class EdgePatternImpl implements EdgePattern
{
	...
	public static final EdgePatternImpl COMPONENT = new EdgePatternImpl
	(Graph.BRANCH_EDGE | Graph.SUCCESSOR_EDGE | Graph.USES_EDGE | Graph.REFINEMENT_EDGE | Graph.SEND_EDGE | Graph.SLOT_EDGE | Graph.DUMMY_EDGE, 0, true, true);	
