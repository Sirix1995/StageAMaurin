...
public class MemoryFileSystem extends FileSystemBase
{
	...
	private class Entry extends ByteArrayOutputStream
	{
		...
		/**
		 * closes a file without activating an TreeModelEvent
		 * 
		 * @param file
		 */
	...
	/**
	 * closes a file without activating an event
	 * 
	 * @param file
	 */
	public synchronized void closeQuiet (Object file) {
		((Entry) file).flush ();
	 ...
	 * @param file
	 */
	public synchronized void close (Object file) {
		((Entry) file).flush ();
		((Entry) file).close ();
	}
