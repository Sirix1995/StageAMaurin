...
/**
 * Instances of <code>ObjectSynth</code> are used in the context of the method
 * {@link Library#synthesize(Object, ObjectToObjectGenerator, ObjectToObject)}.
 ...
 * <code>evaluateObject</code> yields the values of the synthesized attributes of
 * <code>object</code>'s descendants.
 *
 * @author Ole Kniemeyer
 *
 * @param <T> the type of objects for which synthesized attributes are computed
 * @param <V> the type of the synthesized attribute
 *
 */
public final class ObjectSynth<T,V> implements de.grogra.xl.lang.VoidToObjectGenerator<V>
{
	/**
	 * The current object.
	 */
	...
	de.grogra.xl.util.ObjectList<V> valuesList;
	int startIndex;
	 ...
	 */
	public void evaluateObject (de.grogra.xl.lang.ObjectConsumer<? super V> cons)
	{
	 ...
	 */
	public void values (de.grogra.xl.lang.ObjectConsumer<? super V> cons)
	{
		evaluateObject (cons);
	}
