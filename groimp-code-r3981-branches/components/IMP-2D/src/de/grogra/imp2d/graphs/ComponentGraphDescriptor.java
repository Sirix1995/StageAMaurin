...
public class ComponentGraphDescriptor extends FilterDescriptor
{
	//enh:sco
	...
	{
		return new ComponentGraph (source.getGraph (view), (View2DIF)view, Graph.COMPONENT_GRAPH);
	}
...
// NOTE: The following lines up to enh:end were generated automatically
	...
	public static class Type extends FilterDescriptor.Type
	{
		...
		public Type (ComponentGraphDescriptor representative, de.grogra.persistence.SCOType supertype)
		{
		...
		{
			return new ComponentGraphDescriptor ();
		}
	...
	static
	{
		$TYPE = new Type (ComponentGraphDescriptor.class);
		$TYPE.validate ();
	}
