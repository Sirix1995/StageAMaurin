...
public class Triangle extends RectangularShape
{
...
// NOTE: The following lines up to enh:end were generated automatically
	...
	public static class Type extends SCOType
	{
		...
		public Type (Triangle representative, de.grogra.persistence.SCOType supertype)
		{
		...
		protected void setFloat (Object o, int id, float value)
		{
			switch (id)
			{
				case Type.SUPER_FIELD_COUNT + 0:
					((Triangle) o).width = (float) value;
					return;
				case Type.SUPER_FIELD_COUNT + 1:
					((Triangle) o).height = (float) value;
					return;
			}
		...
		protected float getFloat (Object o, int id)
		{
			...
			{
				case Type.SUPER_FIELD_COUNT + 0:
					return ((Triangle) o).width;
				case Type.SUPER_FIELD_COUNT + 1:
					return ((Triangle) o).height;
			}
