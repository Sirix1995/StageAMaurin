...
public class Hexagon extends RectangularShape
{
	float deltaHeight = 0;
...
// NOTE: The following lines up to enh:end were generated automatically
	...
	public static class Type extends SCOType
	{
		...
		public Type (Hexagon representative, de.grogra.persistence.SCOType supertype)
		{
		...
		protected void setFloat (Object o, int id, float value)
		{
			switch (id)
			{
				case Type.SUPER_FIELD_COUNT + 0:
					((Hexagon) o).width = (float) value;
					return;
				case Type.SUPER_FIELD_COUNT + 1:
					((Hexagon) o).height = (float) value;
					return;
			}
		...
		protected float getFloat (Object o, int id)
		{
			...
			{
				case Type.SUPER_FIELD_COUNT + 0:
					return ((Hexagon) o).width;
				case Type.SUPER_FIELD_COUNT + 1:
					return ((Hexagon) o).height;
			}
...
//enh:end
	...
	public PathIterator getPathIterator(AffineTransform at) {
		...
		path.moveTo(0,height/2+deltaHeight);
		path.lineTo(width/2,height/4+deltaHeight);
		path.lineTo(width/2,-height/4+deltaHeight);
		path.lineTo(0,-height/2+deltaHeight);
		path.lineTo(-width/2,-height/4+deltaHeight);
		path.lineTo(-width/2,0+deltaHeight);
		path.lineTo(-width/2,height/4+deltaHeight);
		path.closePath();
