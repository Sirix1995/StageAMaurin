...
public class SplineConnection extends ContextDependentBase implements BSplineCurve
{
	//enh:sco SCOType
...
// NOTE: The following lines up to enh:end were generated automatically
	...
	public static class Type extends SCOType
	{
		...
		public Type (SplineConnection representative, de.grogra.persistence.SCOType supertype)
		{
	...
	static
	{
		$TYPE = new Type (SplineConnection.class);
		$TYPE.validate ();
	}
