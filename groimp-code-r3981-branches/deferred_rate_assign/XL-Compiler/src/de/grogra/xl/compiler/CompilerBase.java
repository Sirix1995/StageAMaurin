		...
		CompilerTokenTypes, Members.Resolution
{
	...
	/**
	 * Stores possible conversions between types for autoconversion.
	 * Each node in the graph represents a type, each edge a conversion.
	 * Nodes and edges provide additional information about how the
	 * conversion can be performed, the visibility of the conversion
	 * operations and more.
	 * <p>
	 * This is the global conversion graph which is valid for all
	 * compilation units. Each compilation unit contains
	 * an additional conversion graph for its imported conversions,
	 * see {@link CompilationUnitScope#getConversionGraph()}.
	 */
	final ConversionGraph conversionGraph = new ConversionGraph ();
	...
	private void checkCvCandidate (Method m)
	{
		...
		if ((standardImplicitConversion (implCvSrc, s, true, implCvScope, null, null, true) != null)
			&& (standardImplicitConversion (new Expression (getConversionType (m, true)), implCvDestType, true, implCvScope, null, null, true) != null)
