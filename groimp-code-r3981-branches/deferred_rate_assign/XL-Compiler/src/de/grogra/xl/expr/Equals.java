...
public strictfp class Equals extends Comparison
{
...
//!! *# End of generated code
	...
	public int writeConditional (BytecodeWriter writer, Label falseLabel, Label trueLabel)
	{
		...
		{
			case BOOLEAN:
				return writeBooleanEquals (writer, falseLabel, trueLabel, true);
			case INT:
				return writeIntObjectComparison
					(writer, falseLabel, trueLabel,
					 Opcodes.IFNE, Opcodes.IFEQ, Opcodes.IFNE, Opcodes.IFEQ,
					 Opcodes.IF_ICMPNE, Opcodes.IF_ICMPEQ);
			case OBJECT:
				return writeIntObjectComparison
					(writer, falseLabel, trueLabel,
					 Opcodes.IFNONNULL, Opcodes.IFNULL, Opcodes.IFNONNULL, Opcodes.IFNULL, Opcodes.IF_ACMPNE, Opcodes.IF_ACMPEQ);
			case LONG:
				return writeLFDComparison
					(writer, falseLabel, trueLabel,
					 Opcodes.LCMP, Opcodes.IFNE, Opcodes.IFEQ);
			case FLOAT:
				return writeLFDComparison
					(writer, falseLabel, trueLabel,
					 Opcodes.FCMPG, Opcodes.IFNE, Opcodes.IFEQ);
			case DOUBLE:
				return writeLFDComparison
					(writer, falseLabel, trueLabel,
					 Opcodes.DCMPG, Opcodes.IFNE, Opcodes.IFEQ);
			default:
				throw new AssertionError ();
		}
	}
