 ...
 * The turtle command
 * <code>DMul(x)</code>
 * multiplies {@link de.grogra.turtle;TurtleState#diameter} by
...
//enh:end
	...
	public static class Pattern extends de.grogra.xl.impl.base.FieldListPattern
	{
		public Pattern ()
		{
			super (DMul.$TYPE, argument$FIELD);
		}

		public static void signature (@In @Out DMul n, float a)
		{
		}
	}
