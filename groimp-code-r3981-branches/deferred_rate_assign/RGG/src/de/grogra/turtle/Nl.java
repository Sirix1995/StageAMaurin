...
//enh:end
	...
	public static class Pattern extends de.grogra.xl.impl.base.FieldListPattern
	{
		public Pattern ()
		{
			super (Nl.$TYPE, argument$FIELD);
		}

		public static void signature (@In @Out Nl n, float a)
		{
		}
	}
	...
	{
		state.localParameter =  (getArgument (node, gs));
	}
}
