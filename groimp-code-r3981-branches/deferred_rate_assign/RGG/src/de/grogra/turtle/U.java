 ...
 * The turtle command
 * <code>U(x)</code>
 * sets {@link de.grogra.turtle;TurtleState#internodeCount} to
...
//enh:end
	...
	public static class Pattern extends de.grogra.xl.impl.base.FieldListPattern
	{
		public Pattern ()
		{
			super (U.$TYPE, argument$FIELD);
		}

		public static void signature (@In @Out U n, float a)
		{
		}
	}
	...
	{
		state.localInternodeCount = state.internodeCount = Math.round (getArgument (node, gs));
	}
}
