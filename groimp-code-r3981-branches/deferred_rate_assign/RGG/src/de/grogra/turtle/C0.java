 ...
 * The turtle command
 * <code>C0</code>
 * resets {@link de.grogra.turtle;TurtleState#carbon} to its initial value
 ...
 * <br>
 * This corresponds to the turtle command <code>C</code>
 * of the GROGRA software.
 *
 * @author Ole Kniemeyer
 */
public class C0 extends
...
//enh:end
	...
	{
		state.localCarbon = state.carbon = state.initialState.carbon;
	}
}
