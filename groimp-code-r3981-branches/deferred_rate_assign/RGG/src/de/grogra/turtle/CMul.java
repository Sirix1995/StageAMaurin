 ...
 * The turtle command
 * <code>CMul(x)</code>
 * multiplies {@link de.grogra.turtle;TurtleState#carbon} by
...
//enh:end
	...
	public static class Pattern extends de.grogra.xl.impl.base.FieldListPattern
	{
		public Pattern ()
		{
			super (CMul.$TYPE, argument$FIELD);
		}

		public static void signature (@In @Out CMul n, float a)
		{
		}
	}
