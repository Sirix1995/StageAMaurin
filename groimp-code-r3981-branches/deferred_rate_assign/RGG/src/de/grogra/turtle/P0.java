 ...
 * The turtle command
 * <code>P0</code>
 * resets {@link de.grogra.turtle;TurtleState#color} to its initial value
 ...
 * <br>
 * This corresponds to the turtle command <code>P</code>
...
//enh:end
	...
	{
		state.localColor = state.color = state.initialState.color;
