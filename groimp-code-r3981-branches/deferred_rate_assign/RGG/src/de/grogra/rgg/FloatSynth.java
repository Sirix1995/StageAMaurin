...
/**
 * Instances of <code>FloatSynth</code> are used in the context of the method
 * {@link Library#synthesize(Object, ObjectToObjectGenerator, ObjectToFloat)}.
 ...
 * <code>evaluateFloat</code> yields the values of the synthesized attributes of
 ...
 *
 */
public final class FloatSynth<T> implements de.grogra.xl.lang.VoidToFloatGenerator
{
	/**
	 * The current object.
	 */
	...
	de.grogra.xl.util.FloatList valuesList;
	int startIndex;
