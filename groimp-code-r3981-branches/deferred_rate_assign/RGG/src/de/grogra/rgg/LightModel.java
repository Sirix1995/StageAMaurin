 ...
 * how many rays are create for that light source. For instance if there were
 ...
 *
 */
public class LightModel extends ShareableBase implements Options,
		VolumeListener
{
	//enh:sco SCOType
	...
	public void compute (Spectrum spectrumFactory)
	{
		...
		if ((processor == null) || (stamp != g.getStamp ()))
		{
