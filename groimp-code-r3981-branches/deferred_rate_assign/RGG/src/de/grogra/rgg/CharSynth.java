...
/**
 * Instances of <code>CharSynth</code> are used in the context of the method
 * {@link Library#synthesize(Object, ObjectToObjectGenerator, ObjectToChar)}.
 ...
 * <code>evaluateChar</code> yields the values of the synthesized attributes of
 ...
 *
 */
public final class CharSynth<T> implements de.grogra.xl.lang.VoidToCharGenerator
{
	/**
	 * The current object.
	 */
	...
	de.grogra.xl.util.CharList valuesList;
	int startIndex;
