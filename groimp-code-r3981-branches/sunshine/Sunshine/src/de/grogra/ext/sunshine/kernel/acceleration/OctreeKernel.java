...
public class OctreeKernel extends AccelerationKernel 
{
	...
	public OctreeKernel(String name, GLAutoDrawable drawable, int[] data, 
			int tileSize, int objects, int steps, int depth) 
	{
