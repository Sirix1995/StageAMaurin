...
public class MicrofacetShader extends ShareableBase implements SunshineSpectralShader, MaterialCollector {
	...
	public BxDFTypes getBxDFType() {
		return MaterialHandler.BxDFTypes.MICROFACET;
	}
...
// NOTE: The following lines up to enh:end were generated automatically
	...
	public static class Type extends de.grogra.persistence.SCOType
	{
		...
		public Type (MicrofacetShader representative, de.grogra.persistence.SCOType supertype)
		{
		...
		protected void setObject (Object o, int id, Object value)
		{
			switch (id)
			{
				case Type.SUPER_FIELD_COUNT + 0:
					((MicrofacetShader) o).diffuse = (SunshineChannel) value;
					return;
				case Type.SUPER_FIELD_COUNT + 1:
					((MicrofacetShader) o).specular = (SunshineChannel) value;
					return;
				case Type.SUPER_FIELD_COUNT + 2:
					((MicrofacetShader) o).roughness = (SunshineChannel) value;
					return;
				case Type.SUPER_FIELD_COUNT + 3:
					((MicrofacetShader) o).cauchy = (SunshineChannel) value;
					return;
				case Type.SUPER_FIELD_COUNT + 4:
					((MicrofacetShader) o).ior = (SunshineChannel) value;
					return;
			}
		...
		protected Object getObject (Object o, int id)
		{
			...
			{
				case Type.SUPER_FIELD_COUNT + 0:
					return ((MicrofacetShader) o).getDiffuse ();
				case Type.SUPER_FIELD_COUNT + 1:
					return ((MicrofacetShader) o).getSpecular ();
				case Type.SUPER_FIELD_COUNT + 2:
					return ((MicrofacetShader) o).getRoughness ();
				case Type.SUPER_FIELD_COUNT + 3:
					return ((MicrofacetShader) o).getCauchy ();
				case Type.SUPER_FIELD_COUNT + 4:
					return ((MicrofacetShader) o).getIor ();
			}
	...
	static
	{
		$TYPE = new Type (MicrofacetShader.class);
		...
		cauchy$FIELD = Type._addManagedField ($TYPE, "cauchy", 0 | Type.Field.SCO, de.grogra.reflect.ClassAdapter.wrap (SunshineChannel.class), null, Type.SUPER_FIELD_COUNT + 3);
		ior$FIELD = Type._addManagedField ($TYPE, "ior", 0 | Type.Field.SCO, de.grogra.reflect.ClassAdapter.wrap (SunshineChannel.class), null, Type.SUPER_FIELD_COUNT + 4);
		$TYPE.validate ();
	}
