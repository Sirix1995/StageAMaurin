 ...
 *
 */
public class TraceLightRayKernel extends InterruptableTraceRayKernel
{

	private String INFOS 	= "getLightVertexInfos.frag";
	 ...
	 * @param steps
	 */
	public TraceLightRayKernel(String name, GLAutoDrawable drawable,
