...
public class ReadFromURL {
	...
	final static String[] names = {
			...
			"LIGHT_GREEN",
			"LIGHT_YELLOW_GREEN",
			"LITE_YELLOWISH_GREEN",
			"MODERATE_GREEN",
			"MODERATE_OLIVE",
			"MODERATE_OLIVE_GREEN",
			"MODERATE_YELLOW_GREE",
			"MOD_BLUISH_GREEN",
			"MOD_YELLOWISH_GREEN",
			"PALE_GREEN",
			"PALE_YELLOW_GREEN",
			...
			"SALMON",
			"TOLEDO_RED",
			"3000K_TUNGSTEN_INCAN",
			"COOL_WHITE",
			"FLUORESCENT_INCANDES",
			"NATURAL",
			"SOURCE_A",
			"SOURCE_B",
			"SOURCE_C",
