...
public class SunshineBlackBodySpectrumChannel extends ShareableBase implements
		SunshineChannel {

	//enh:sco de.grogra.persistence.SCOType
	
	float temperature = 6500f;
	// enh:field quantity=TEMPERATURE setmethod=setTemperature
	...
	{
		// Number of wavelengths is number of step with size one between the limits.
