 ...
 * The turtle command
 * <code>V0</code>
 * resets {@link de.grogra.turtle.TurtleState#tropism} to its initial value
 ...
 * <br>
 * This corresponds to the turtle command <code>V</code>
 * of the GROGRA software.
 *
 * @author Ole Kniemeyer
 */
public class V0 extends
...
//enh:end
	...
	{
		state.localTropism = state.tropism = state.initialState.tropism;
	}
}
