...
public class TextureManager
{
	...
	final Hashtable<Image, Texture> texHash = new Hashtable<Image, Texture> ();
	...
	public void deleteTextures(GL gl){
		Enumeration<Texture> textures = texHash.elements();
