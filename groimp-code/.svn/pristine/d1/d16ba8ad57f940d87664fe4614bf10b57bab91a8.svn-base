...
public interface LSYTokenTypes {
	...
	// "\\register" = 234
	// "\\var" = 235
	int LITERAL_uniform = 236;
	int LITERAL_normal = 237;
	int LITERAL_binomial = 238;
	int LITERAL_negbinomial = 239;
	int LITERAL_poisson = 240;
	int LITERAL_distribution = 241;
	int LITERAL_table = 242;
	int LITERAL_generation = 243;
	int LITERAL_register = 244;
	int LITERAL_local = 245;
	int LITERAL_index = 246;
	int LITERAL_length = 247;
	int LITERAL_diameter = 248;
	int LITERAL_n_value = 249;
	int LITERAL_v_value = 250;
	int LITERAL_color = 251;
	int LITERAL_order = 252;
	int LITERAL_carbon = 253;
	int LITERAL_q_value = 254;
	int LITERAL_xcoordinate = 255;
	int LITERAL_ycoordinate = 256;
	int LITERAL_zcoordinate = 257;
	int LITERAL_function = 258;
	// "#" = 259
	// "##" = 260
	// "?" = 261
	// "&" = 262
	int LITERAL_if = 263;
	int LITERAL_sum = 264;
	int LITERAL_sumd = 265;
	int LITERAL_sump = 266;
}
