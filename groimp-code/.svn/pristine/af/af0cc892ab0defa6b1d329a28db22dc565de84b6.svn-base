 ...
 * the sum of {@link de.grogra.turtle.TurtleState#carbon} and
...
//enh:end
	...
	public static class Pattern extends de.grogra.xl.impl.base.FieldListPattern
	{
		public Pattern ()
		{
			super (ClAdd.$TYPE, argument$FIELD);
		}

		public static void signature (@In @Out ClAdd n, float a)
		{
		}
	}
