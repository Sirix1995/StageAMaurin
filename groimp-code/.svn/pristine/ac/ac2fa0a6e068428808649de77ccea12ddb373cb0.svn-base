...
import de.grogra.imp3d.gl.TextRenderer3D;
		...
		RenderState, ImageObserver, Selectable
{
	...
	protected boolean optionRenderAsWireframe = false;
...
//				float attenuationExponent = spotLight.getAttenuationExponent ();
			...
			Shader s, int highlight, boolean asWireframe, Matrix4d t)
	{
		...
		if(asWireframe || optionRenderAsWireframe) gl.glPolygonMode (GL.GL_FRONT_AND_BACK, GL.GL_LINE);
	...
	@Override
	public void drawLamella(float halfWidth, float halfLength, float height,
			float a, float b, Shader s, int highlight, boolean asWireframe, Matrix4d t) {
...
//	}
	...
	class SphereSegmentSolidDisplayListRenderable extends DisplayListRenderable
	{
		GL gl;
		float radius, theta1, theta2, phi;
		
		SphereSegmentSolidDisplayListRenderable (GL gl, float radius, float theta1, float theta2, float phi)
		{
			this.gl = gl;
			this.radius = radius;
			this.theta1 = theta1;
	...
	public void drawSphereSegmentSolid (float radius, float theta1, float theta2, float phi, Shader s, int highlight, boolean asWireframe, Matrix4d t)
	{
		...
		// draw the sphere
		dlSphereSegment = drawWithDisplayList (dlSphereSegment, gl,
			new SphereSegmentSolidDisplayListRenderable (gl, radius, theta1, theta2, phi), LOD_LEVELS, lod);
			...
			int highlight, boolean asWireframe, Matrix4d t)
	{
		...
		// draw the frustum //
		drawFrustumImpl (gl, uCount, topClosed, topRadius, baseClosed, baseRadius, scaleV);
