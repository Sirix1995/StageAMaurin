...
public abstract class BooleanTreeAttribute extends BooleanAttribute
{
	...
	{
		final ObjectMap<BooleanTreeAttribute.Listener> listeners;
		...
		void fire (GraphState gs, Object o, BooleanTreeAttribute.Listener l)
		{
			...
			if (!queueEvents)
			{
				...
				try
				{
					while (!pendingEvents.isEmpty ())
					{
						...
						{
							l = (BooleanTreeAttribute.Listener) queue.get (i);
	...
	final class Listener implements AttributeChangeListener
	{
		...
		BooleanTreeAttribute getAttribute ()
		{
			return BooleanTreeAttribute.this;
		}
	...
	protected abstract boolean derive (Object object, boolean asNode, boolean parentValue,
									 GraphState gs);
	...
	public boolean getParentValue (Object object, boolean asNode,
								 GraphState gs)
	{
		...
		{
			gs.moveToPreviousInstance ();
			boolean v = getDerived (gs.getInstancingPath ().getObject (i - 1), !asNode,
								  gs);
			gs.moveToNextInstance ();
			return v;
		}
