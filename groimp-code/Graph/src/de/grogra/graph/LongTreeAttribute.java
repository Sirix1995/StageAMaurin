...
public abstract class LongTreeAttribute extends LongAttribute
{
	...
	{
		final ObjectMap<LongTreeAttribute.Listener> listeners;
		...
		void fire (GraphState gs, Object o, LongTreeAttribute.Listener l)
		{
			...
			if (!queueEvents)
			{
				...
				try
				{
					while (!pendingEvents.isEmpty ())
					{
						...
						{
							l = (LongTreeAttribute.Listener) queue.get (i);
	...
	protected abstract long derive (Object object, boolean asNode, long parentValue,
									 GraphState gs);
	...
	public long getParentValue (Object object, boolean asNode,
								 GraphState gs)
	{
		...
		{
			gs.moveToPreviousInstance ();
			long v = getDerived (gs.getInstancingPath ().getObject (i - 1), !asNode,
								  gs);
			gs.moveToNextInstance ();
			return v;
		}
