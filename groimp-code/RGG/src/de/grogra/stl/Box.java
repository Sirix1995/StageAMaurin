...
public class Box extends ObjectBase {
			...
			throws IOException
	{
		...
		writeFace(new Vector3d(p[3].x,p[3].y,p[3].z),new Vector3d(p[2].x,p[2].y,p[2].z),new Vector3d(p[4].x,p[4].y,p[4].z));
		writeFace(new Vector3d(p[3].x,p[3].y,p[3].z),new Vector3d(p[4].x,p[4].y,p[4].z),new Vector3d(p[5].x,p[5].y,p[5].z));
		writeFace(new Vector3d(p[5].x,p[5].y,p[5].z),new Vector3d(p[4].x,p[4].y,p[4].z),new Vector3d(p[6].x,p[6].y,p[6].z));
		writeFace(new Vector3d(p[5].x,p[5].y,p[5].z),new Vector3d(p[6].x,p[6].y,p[6].z),new Vector3d(p[7].x,p[7].y,p[7].z));
		writeFace(new Vector3d(p[7].x,p[7].y,p[7].z),new Vector3d(p[6].x,p[6].y,p[6].z),new Vector3d(p[0].x,p[0].y,p[0].z));
		writeFace(new Vector3d(p[7].x,p[7].y,p[7].z),new Vector3d(p[0].x,p[0].y,p[0].z),new Vector3d(p[1].x,p[1].y,p[1].z));
		writeFace(new Vector3d(p[4].x,p[4].y,p[4].z),new Vector3d(p[2].x,p[2].y,p[2].z),new Vector3d(p[0].x,p[0].y,p[0].z));
		writeFace(new Vector3d(p[0].x,p[0].y,p[0].z),new Vector3d(p[6].x,p[6].y,p[6].z),new Vector3d(p[4].x,p[4].y,p[4].z));
