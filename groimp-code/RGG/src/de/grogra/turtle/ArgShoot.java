...
public abstract class ArgShoot extends Shoot
{
	public float argument;
	//enh:field attr=Attributes.ARGUMENT

//enh:insert $TYPE.addDependency (TurtleStateAttribute.ATTRIBUTE, Attributes.LENGTH);
//enh:begin
// NOTE: The following lines up to enh:end were generated automatically
	...
	private static final class _Field extends NType.Field
	{
		...
		{
			super (ArgShoot.$TYPE, name, modifiers, type, componentType);
			this.id = id;
		}
		...
		public void setFloat (Object o, float value)
		{
			...
			{
				case 0:
					((ArgShoot) o).argument = (float) value;
					return;
			}
...
//enh:end
	...
	public ArgShoot (float argument)
	{
		super ();
