...
import de.grogra.math.util.OaHashSet;
...
public class EarSet implements StarVisitor {
	...
	private final LinkedList<OrientedFace> ears = new LinkedList<OrientedFace>();
	private final Set<Ear> visited = new OaHashSet<Ear>();
