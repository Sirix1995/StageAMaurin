...
//			gl.glFlush();
	...
	public void drawPlane(Shader s, int highlight,boolean asWireframe,  Matrix4d t) {
		...
		if(asWireframe) gl.glPolygonMode (GL.GL_FRONT_AND_BACK, GL.GL_FILL);
	...
	public void drawPolygons(Polygonizable pz, Object obj, boolean asNode,
		...
		drawPolygons(pz, obj, asNode, s, highlight, asWireframe, t, -1, true, true);
	}
	 ...
	 */
	public void drawPolygons(Polygonizable pz, Object obj, boolean asNode,
			Shader s, int highlight, boolean asWireframe, Matrix4d t, int defaultCulledSide,
	...
	public boolean isOptionRenderAsWireframe() {
		return optionRenderAsWireframe;
	}
