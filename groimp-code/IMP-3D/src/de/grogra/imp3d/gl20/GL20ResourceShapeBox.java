...
public class GL20ResourceShapeBox extends GL20ResourceShape {
	 ...
	 */
	final private static String MESH_BOX_NAME = new String("BOX");

	/**
	 * halfWidth attribute bit
	 */
	final private static int HALF_WIDTH = 0x1;

	/**
	 * halfLength attribute bit
	 */
	final private static int HALF_LENGTH = 0x2;

	/**
	 * height attribute bit
	 */
	final private static int HEIGHT = 0x4;
	...
	public GL20ResourceShapeBox() {
		...
		if (mesh == null) {
			// no mesh with the MESH_BOX_NAME was found, so create one
			...
			uvList.add(1.0f); uvList.add(1.0f);
			uvList.add(0.0f); uvList.add(1.0f);
			vertexList.add(-1.0f); vertexList.add(-1.0f); vertexList.add(1.0f);
			vertexList.add(1.0f); vertexList.add(-1.0f); vertexList.add(1.0f);
			vertexList.add(1.0f); vertexList.add(1.0f); vertexList.add(1.0f);
			vertexList.add(-1.0f); vertexList.add(1.0f); vertexList.add(1.0f);
			...
			vertexList.add(-1.0f); vertexList.add(1.0f); vertexList.add(1.0f);
			vertexList.add(-1.0f); vertexList.add(1.0f); vertexList.add(0.0f);
			polygonList.add(8); polygonList.add(9); polygonList.add(10); polygonList.add(11);
			...
			vertexList.add(1.0f); vertexList.add(1.0f); vertexList.add(1.0f);
			vertexList.add(1.0f); vertexList.add(-1.0f); vertexList.add(1.0f);
			polygonList.add(12); polygonList.add(13); polygonList.add(14); polygonList.add(15);
			...
			vertexList.add(1.0f); vertexList.add(1.0f); vertexList.add(1.0f);
			vertexList.add(1.0f); vertexList.add(1.0f); vertexList.add(0.0f);
			polygonList.add(16); polygonList.add(17); polygonList.add(18); polygonList.add(19);
			...
			vertexList.add(1.0f); vertexList.add(-1.0f); vertexList.add(1.0f);
			vertexList.add(-1.0f); vertexList.add(-1.0f); vertexList.add(1.0f);
			polygonList.add(20); polygonList.add(21); polygonList.add(22); polygonList.add(23);
	 ...
	 */
	final public void setHalfWidth(float halfWidth) {
	 ...
	 */
	final public float getHalfWidth() {
		return halfWidth;
	}
	 ...
	 */
	final public void setHalfLength(float halfLength) {
	 ...
	 */
	final public float getHalfLength() {
		return halfLength;
	}
