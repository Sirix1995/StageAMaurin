 ...
 * by filter sources whose flavor supports <code>OutputStream</code>s
 * ({@link de.grogra.pf.io.IOFlavor#OUTPUT_STREAM}). It represents the data
 * by writing it to an <code>OutputStream</code>.
 * 
